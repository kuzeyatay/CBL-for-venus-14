//#region node_modules/mqtt/dist/mqtt.esm.js
...
var j = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), Kr = (t, e) => {
	for (var r in e) as(t, r, {
		get: e[r],
		enumerable: !0
	});
}, Zb = (t, e, r, n) => {
	if (e && typeof e == "object" || typeof e == "function") for (let i of Jb(e)) !Xb.call(t, i) && i !== r && as(t, i, {
		get: () => e[i],
		enumerable: !(n = Yb(e, i)) || n.enumerable
	});
	return t;
};
var me = (t) => Zb(as({}, "__esModule", { value: !0 }), t);
var A = ze(() => {});
var N = {};
Kr(N, {
	_debugEnd: () => Kc,
	...
	_getActiveRequests: () => kc,
	_kill: () => Mc,
	_linkedBinding: () => xc,
	_maxListeners: () => cf,
	_preload_modules: () => af,
	_rawDebug: () => Ac,
	_startProfilerIdleNotifier: () => Qc,
	_stopProfilerIdleNotifier: () => Yc,
	_tickCallback: () => Gc,
	abort: () => ef,
	addListener: () => df,
	allowedNodeEnvironmentFlags: () => jc,
	arch: () => cc,
	argv: () => dc,
	argv0: () => sf,
	assert: () => Fc,
	...
	exit: () => Uc,
	features: () => Wc,
	hasUncaughtExceptionCaptureCallback: () => Vc,
	hrtime: () => Oi,
	kill: () => Lc,
	listeners: () => vf,
	memoryUsage: () => qc,
	...
	ppid: () => rf,
	prependListener: () => mf,
	prependOnceListener: () => _f,
	reallyExit: () => Bc,
	release: () => Sc,
	removeAllListeners: () => bf,
	removeListener: () => gf,
	resourceUsage: () => Nc,
	setSourceMapsEnabled: () => uf,
	setUncaughtExceptionCaptureCallback: () => Hc,
	stderr: () => Xc,
	stdin: () => Zc,
	stdout: () => Jc,
	title: () => lc,
...
function ew() {
	!Qr || !wr || (Qr = !1, wr.length ? Mt = wr.concat(Mt) : Pi = -1, Mt.length && sc());
}
function sc() {
	if (!Qr) {
...
function Oi(t) {
	var e = Math.floor((Date.now() - Jt.now()) * .001), r = Jt.now() * .001, n = Math.floor(r) + e, i = Math.floor(r % 1 * 1e9);
...
var Mt, Qr, wr, Pi, lc, cc, fc, hc, dc, pc, yc, gc, bc, wc, mc, _c, vc, Sc, Ec, Ac, Ic, Tc, Pc, Oc, Bc, Mc, Ri, Nc, qc, Lc, Uc, Dc, jc, Wc, $c, Hc, Gc, zc, Kc, Qc, Yc, Jc, Xc, Zc, ef, tf, rf, nf, of, sf, af, uf, Jt, us, ls, cf, ff, hf, df, pf, yf, gf, bf, wf, mf, _f, Sf, Ef = ze(() => {
	A();
	x();
	I();
	Mt = [], Qr = !1, Pi = -1;
	...
	lc = "browser", cc = "x64", fc = "browser", hc = {
		PATH: "/usr/bin",
		LANG: typeof navigator < "u" ? navigator.language + ".UTF-8" : void 0,
		PWD: "/",
		HOME: "/home",
		TMP: "/tmp"
	}, dc = ["/usr/bin/node"], pc = [], yc = "v16.8.0", gc = {}, bc = function(t, e) {
		console.warn((e ? e + ": " : "") + t);
	}, wc = function(t) {
		cs("binding");
	}, mc = function(t) {
	...
	Gc = Ue, zc = Ue, Kc = Ue, Qc = Ue, Yc = Ue, Jc = void 0, Xc = void 0, Zc = void 0, ef = Ue, tf = 2, rf = 1, nf = "/bin/usr/node", of = 9229, sf = "node", af = [], uf = Ue, Jt = {
...
function tw() {
	if (Af) return On;
	Af = !0, On.byteLength = a, On.toByteArray = f, On.fromByteArray = m;
...
function rw() {
	...
	return ki.read = function(t, e, r, n, i) {
		...
		if (s === 0) s = 1 - f;
			...
			if (s === c) return o ? NaN : (g ? -1 : 1) * Infinity;
		...
		for (e = Math.abs(e), isNaN(e) || e === Infinity ? (a = isNaN(e) ? 1 : 0, o = h) : (o = Math.floor(Math.log(e) / Math.LN2), e * (c = Math.pow(2, -o)) < 1 && (o--, c *= 2), o + d >= 1 ? e += m / c : e += m * Math.pow(2, 1 - d), e * c >= 2 && (o++, c /= 2), o + d >= h ? (a = 0, o = h) : o + d >= 1 ? (a = (e * c - 1) * Math.pow(2, i), o = o + d) : (a = e * Math.pow(2, d - 1) * Math.pow(2, i), o = 0)); i >= 8; t[r + g] = a & 255, g += P, a /= 256, i -= 8);
...
function Tf() {
	...
	function _(p, u) {
		...
		let l = p.length, E = arguments.length > 2 && arguments[2] === !0;
		if (!E && l === 0) return 0;
		let C = !1;
		for (;;) switch (u) {
			case "ascii":
			...
			case "utf8":
			case "utf-8": return Ct(p).length;
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return l * 2;
			case "hex": return l >>> 1;
			case "base64": return Ii(p).length;
			default:
	...
	function R(p, u, l) {
		...
		for (p || (p = "utf8");;) switch (p) {
			case "hex": return V(this, u, l);
			case "utf8":
			case "utf-8": return H(this, u, l);
			case "ascii": return ee(this, u, l);
			case "latin1":
			case "binary": return G(this, u, l);
			case "base64": return W(this, u, l);
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return te(this, u, l);
			default:
	...
	o.prototype.includes = function(u, l, E) {
		...
		return y(this, u, l, E, !0);
	}, o.prototype.lastIndexOf = function(u, l, E) {
		return y(this, u, l, E, !1);
	};
	function v(p, u, l, E) {
		l = Number(l) || 0;
		let C = p.length - l;
	...
	o.prototype.write = function(u, l, E, C) {
		...
		let $ = !1;
		for (;;) switch (C) {
			case "hex": return v(this, u, l, E);
			case "utf8":
			case "utf-8": return M(this, u, l, E);
			case "ascii":
			case "latin1":
			case "binary": return F(this, u, l, E);
			case "base64": return U(this, u, l, E);
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return Q(this, u, l, E);
			default:
			...
			if (C + k <= l) {
				...
				switch (k) {
					...
					case 3:
						...
						break;
					case 4: B = p[C + 1], re = p[C + 2], ie = p[C + 3], (B & 192) === 128 && (re & 192) === 128 && (ie & 192) === 128 && (oe = (q & 15) << 18 | (B & 63) << 12 | (re & 63) << 6 | ie & 63, oe > 65535 && oe < 1114112 && ($ = oe));
				}
			}
	...
	o.prototype.readUintLE = o.prototype.readUIntLE = function(u, l, E) {
		...
		return u = u >>> 0, l || Y(u, 4, this.length), e.read(this, u, !0, 23, 4);
	}, o.prototype.readFloatBE = function(u, l) {
		return u = u >>> 0, l || Y(u, 4, this.length), e.read(this, u, !1, 23, 4);
	}, o.prototype.readDoubleLE = function(u, l) {
		return u = u >>> 0, l || Y(u, 8, this.length), e.read(this, u, !0, 52, 8);
	}, o.prototype.readDoubleBE = function(u, l) {
		return u = u >>> 0, l || Y(u, 8, this.length), e.read(this, u, !1, 52, 8);
	};
...
Kr(qe, {
	Buffer: () => D,
	INSPECT_MAX_BYTES: () => nw,
	default: () => Xt,
	kMaxLength: () => iw
});
var Xt, D, nw, iw, ke = ze(() => {
	A();
	x();
	I();
	Pf();
		...
		inspect(t) {
			switch (typeof t) {
				case "string":
					...
					return `'${t}'`;
				case "number": return isNaN(t) ? "NaN" : Object.is(t, -0) ? String(t) : t;
				case "bigint": return `${String(t)}n`;
				case "boolean":
				case "undefined": return String(t);
				case "object": return "{}";
			}
		}
	};
...
var De = j((eO, Bf) => {
	...
	x();
	I();
	var { format: ow, inspect: Ci } = hs(), { AggregateError: sw } = Ee(), aw = globalThis.AggregateError || sw, uw = Symbol("kIsNodeError"), lw = [
		"string",
		"function",
		"number",
		"object",
		...
		"bigint",
		"symbol"
	], cw = /^([A-Z][a-z0-9]*)+$/, fw = "__node_internal_", Bi = {};
	function _r(t, e) {
	...
	function Le(t, e, r) {
		...
		}), n.prototype.code = t, n.prototype[uw] = !0, Bi[t] = n;
	}
	function Cf(t) {
		let e = fw + t.name;
	...
	Le("ERR_INVALID_RETURN_VALUE", (t, e, r) => {
		var n;
		return `Expected ${t} to be returned from the "${e}" function but got ${r != null && (n = r.constructor) !== null && n !== void 0 && n.name ? `instance of ${r.constructor.name}` : `type ${typeof r}`}.`;
	}, TypeError);
...
function yw() {
	...
	s.prototype.getMaxListeners = function() {
		...
		if (M) {
			...
			var Q = /* @__PURE__ */ new Error("Unhandled error." + (U ? " (" + U.message + ")" : ""));
			throw Q.context = U, Q;
		}
		var W = F[y];
	...
	function f(T, y, O, v) {
		var M, F, U;
		if (a(O), F = T._events, F === void 0 ? (F = T._events = Object.create(null), T._eventsCount = 0) : (F.newListener !== void 0 && (T.emit("newListener", y, O.listener ? O.listener : O), F = T._events), U = F[y]), U === void 0) U = F[y] = O, ++T._eventsCount;
		else if (typeof U == "function" ? U = F[y] = v ? [O, U] : [U, O] : v ? U.unshift(O) : U.push(O), M = c(T), M > 0 && U.length > M && !U.warned) {
			U.warned = !0;
			var Q = /* @__PURE__ */ new Error("Possible EventEmitter memory leak detected. " + U.length + " " + String(y) + " listeners added. Use emitter.setMaxListeners() to increase limit");
	...
	s.prototype.once = function(y, O) {
		...
		if (v === O || v.listener === O) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete M[y], M.removeListener && this.emit("removeListener", y, v.listener || O));
		...
		if (v.removeListener === void 0) return arguments.length === 0 ? (this._events = Object.create(null), this._eventsCount = 0) : v[y] !== void 0 && (--this._eventsCount === 0 ? this._events = Object.create(null) : delete v[y]), this;
	...
	function w(T, y) {
		return new Promise(function(O, v) {
			...
			R(T, y, F, { once: !0 }), y !== "error" && _(T, M, { once: !0 });
		});
	}
	function _(T, y, O) {
...
var Ni, Nf, Rn, gw, bw, ww, mw, _w, vw, er = ze(() => {
	A();
	x();
	I();
	Ni = {}, Nf = !1;
	...
	Rn.on = function(t, e) {
		let r = [], n = [], i = null, s = !1, o = {
			async next() {
				...
				return s ? createIterResult(void 0, !0) : new Promise((h, d) => n.push({
					resolve: h,
					reject: d
				}));
			},
			async return() {
				t.removeListener(e, a), t.removeListener("error", c), s = !0;
				for (let f of n) f.resolve(createIterResult(void 0, !0));
		...
		function a(...f) {
			let h = n.shift();
			h ? h.resolve(createIterResult(f, !1)) : r.push(f);
		}
		function c(f) {
			s = !0;
			let h = n.shift();
...
var $e = j((OO, ys) => {
	...
	ys.exports = {
		...
		AbortSignalAny: Pw.any || function(e) {
			...
			return e.forEach((i) => {
				Lf(i, "signals"), i.addEventListener("abort", n, { once: !0 });
...
var Xr = j((DO, zf) => {
	...
	var em = et((t, e, r) => {
		if (!Ff(r, t)) throw new Jr(e, t, "must be one of: " + Wf(Bw(r, (s) => typeof s == "string" ? `'${s}'` : Dw(s)), ", "));
	});
	function Vf(t, e) {
	...
	var tm = et((t, e, r = null) => {
		let n = gs(r, "allowArray", !1), i = gs(r, "allowFunction", !1);
		if (!gs(r, "nullable", !1) && t === null || !n && bs(t) || typeof t != "object" && (!i || typeof t != "function")) throw new je(e, "Object", t);
	}), rm = et((t, e) => {
		if (t != null && typeof t != "object" && typeof t != "function") throw new je(e, "a dictionary", t);
	}), qi = et((t, e, r = 0) => {
		if (!bs(t)) throw new je(e, "Array", t);
		if (t.length < r) throw new Jr(e, t, `must be longer than ${r}`);
	});
	function nm(t, e) {
		qi(t, e);
	...
	zf.exports = {
		...
		parseFileMode: Yw,
		validateArray: qi,
		validateStringArray: nm,
		validateBooleanArray: im,
		validateAbortSignalArray: om,
		validateBoolean: Vf,
		validateBuffer: am,
		validateDictionary: rm,
		validateEncoding: um,
		validateFunction: cm,
		validateInt32: Xw,
		validateInteger: Jw,
		...
		validateObject: tm,
		validateOneOf: em,
		validatePlainFunction: fm,
		validatePort: lm,
		validateSignalName: sm,
		validateString: ms,
		validateUint32: Hf,
		validateUndefined: hm,
		validateUnion: dm,
		validateAbortSignal: Gf,
		validateLinkHeaderValue: ym
	};
});
var tr = j((QO, Jf) => {
	A();
	...
	var qt = [], Zr = !1, Sr, Li = -1;
	function bm() {
		!Zr || !Sr || (Zr = !1, Sr.length ? qt = Sr.concat(qt) : Li = -1, qt.length && Qf());
	}
	function Qf() {
		if (!Zr) {
			var t = Kf(bm);
...
var mt = j((oR, hh) => {
	...
	function Sm(t, e) {
		return t == null ? !1 : e === !0 ? typeof t[Xf] == "function" : e === !1 ? typeof t[Zf] == "function" : typeof t[Xf] == "function" || typeof t[Zf] == "function";
	}
	function ji(t) {
		if (!wt(t)) return null;
	...
	function uh(t) {
		return t && t[Ss] != null ? t[Ss] : typeof t?.readable != "boolean" ? null : ji(t) ? !1 : Ui(t) && t.readable && !ah(t);
	}
	function lh(t) {
		return t && t[Es] != null ? t[Es] : typeof t?.writable != "boolean" ? null : ji(t) ? !1 : Di(t) && t.writable && !sh(t);
	}
	function Im(t, e) {
		return wt(t) ? ji(t) ? !0 : !(e?.readable !== !1 && uh(t) || e?.writable !== !1 && lh(t)) : null;
	}
	function xm(t) {
		var e, r;
	...
	function Rm(t) {
		if (!wt(t)) return null;
		let e = t._writableState, r = t._readableState, n = e || r;
		return !n && fh(t) || !!(n && n.autoDestroy && n.emitClose && n.closed === !1);
	}
	function km(t) {
		var e;
	...
	hh.exports = {
		...
		kIsReadable: Ss,
		kIsClosedPromise: wm,
		kControllerErrorFunction: mm,
		kIsWritable: Es,
		isClosed: Pm,
		isDuplexNodeStream: _m,
		isFinished: Im,
		isIterable: Sm,
		isReadableNodeStream: Ui,
		isReadableStream: nh,
		isReadableEnded: Am,
		isReadableFinished: ah,
		isReadableErrored: Tm,
		isNodeStream: wt,
		isWebStream: vm,
		isWritable: lh,
		isWritableNodeStream: Di,
		isWritableStream: ih,
		isWritableEnded: sh,
		isWritableFinished: Em,
		isWritableErrored: xm,
		isServerRequest: Om,
		isServerResponse: fh,
		willEmitClose: Rm,
		isTransformStream: oh
	};
});
var Ut = j((yR, Ps) => {
	"use strict";
	...
	function Eh(t, e, r) {
		...
		let s = (n = e.readable) !== null && n !== void 0 ? n : As(t), o = (i = e.writable) !== null && i !== void 0 ? i : wh(t), a = t._writableState, c = t._readableState, f = () => {
			t.writable || m();
		}, h = Vm(t) && As(t) === s && wh(t) === o, d = mh(t, !1), m = () => {
			d = !0, t.destroyed && (h = !1), !(h && (!t.readable || s)) && (!s || g) && r.call(t);
		}, g = yh(t, !1), P = () => {
			g = !0, t.destroyed && (h = !1), !(h && (!t.writable || o)) && (!o || d) && r.call(t);
		}, S = (y) => {
			r.call(t, y);
		}, b = Fm(t), w = () => {
			b = !0;
			...
			if (s && !g && As(t, !0) && !yh(t, !1)) return r.call(t, new dh());
			if (o && !d && !mh(t, !1)) return r.call(t, new dh());
			r.call(t);
		}, _ = () => {
			b = !0;
			let y = _h(t) || gh(t);
	...
	function Km(t, e, r) {
		let n = !1, i = Ts;
		if (e.signal) if (i = () => {
			n = !0, r.call(t, new vh(void 0, { cause: e.signal.reason }));
...
var Ar = j((IR, kh) => {
	...
	function n_(t, e) {
		...
		return n != null && n.destroyed || r != null && r.destroyed ? (typeof e == "function" && e(), this) : (Ph(t, n, r), n && (n.destroyed = !0), r && (r.destroyed = !0), i.constructed ? Ah(this, t, e) : this.once(Th, function(s) {
			Ah(this, Ym(s, t), e);
		}), this);
	}
	function Ah(t, e, r) {
		...
		function i(s) {
			...
			Ph(s, a, o), a && (a.closed = !0), o && (o.closed = !0), typeof r == "function" && r(s), s ? _t.nextTick(i_, t, s) : _t.nextTick(Oh, t);
		}
		try {
			t._destroy(e || null, i);
		} catch (s) {
	...
	function s_(t, e) {
		...
		let r = t._readableState, n = t._writableState;
		r && (r.constructed = !1), n && (n.constructed = !1), t.once(Os, e), !(t.listenerCount(Os) > 1) && _t.nextTick(a_, t);
	}
	function a_(t) {
		let e = !1;
		function r(n) {
			...
			i && (i.constructed = !0), s && (s.constructed = !0), o.destroyed ? t.emit(Th, n) : n ? ks(t, n, !0) : _t.nextTick(u_, t);
		}
		try {
			t._construct((n) => {
				_t.nextTick(r, n);
	...
	function c_(t, e) {
		!t || e_(t) || (!e && !t_(t) && (e = new Xm()), r_(t) ? (t.socket = null, t.destroy(e)) : Ih(t) ? t.abort() : Ih(t.req) ? t.req.abort() : typeof t.destroy == "function" ? t.destroy(e) : typeof t.close == "function" ? t.close() : e ? _t.nextTick(l_, t, e) : _t.nextTick(Rh, t), t.destroyed || (t[Zm] = !0));
	}
	kh.exports = {
		construct: s_,
		destroyer: c_,
...
var kn = j((VR, Hi) => {
	...
	Hi.exports.addAbortSignal = function(e, r) {
		if (b_(e, "signal"), !Nh(r) && !p_(r)) throw new qh("stream", [
			"ReadableStream",
			"WritableStream",
			"Stream"
		], r);
...
var Cn = j((hk, $h) => {
	...
	function T_(t, e, r, n) {
		let i = I_(e, n, r);
		if (i != null) {
			if (!S_(i) || i < 0) throw new A_(n ? `options.${r}` : "options.highWaterMark", i);
			return v_(i);
		}
	...
	$h.exports = {
		getHighWaterMark: T_,
		getDefaultHighWaterMark: Wh,
		setDefaultHighWaterMark: x_
	};
});
var Gh = j((Ns, Vh) => {
	A();
...
var Us = j((Fk, Zh) => {
	...
	function V_(t, e, r) {
		let n;
		if (typeof e == "string" || e instanceof W_) return new t({
			objectMode: !0,
			...r,
			read() {
		...
		let i;
		if (e && e[Jh]) i = !0, n = e[Jh]();
		else if (e && e[Xh]) i = !1, n = e[Xh]();
...
var Nn = j((Jk, bd) => {
	...
	rd(le, nr);
	var js = () => {}, { errorOrDestroy: tn } = nn, rn = 1, yv = 2, sd = 4, Mn = 8, ad = 16, zi = 32, Ki = 64, ud = 128, gv = 256, bv = 512, wv = 1024, Hs = 2048, Vs = 4096, mv = 8192, _v = 16384, vv = 32768, ld = 65536, Sv = 1 << 17, Ev = 1 << 18;
	function Ce(t) {
		return {
			enumerable: !1,
			get() {
	...
	Gs(Yi.prototype, {
		...
		sync: Ce(zi),
		needReadable: Ce(Ki),
		emittedReadable: Ce(ud),
		readableListening: Ce(gv),
		resumeScheduled: Ce(bv),
		errorEmitted: Ce(wv),
		emitClose: Ce(Hs),
		autoDestroy: Ce(Vs),
		destroyed: Ce(mv),
	...
	le.prototype.push = function(t, e) {
		return cd(this, t, e, !1);
	};
	le.prototype.unshift = function(t, e) {
		return cd(this, t, e, !0);
	};
	function cd(t, e, r, n) {
		de("readableAddChunk", e);
		let i = t._readableState, s;
		if ((i.state & rn) === 0 && (typeof e == "string" ? (r = r || i.defaultEncoding, i.encoding !== r && (n && i.encoding ? e = Ds.from(e, r).toString(i.encoding) : (e = Ds.from(e, r), r = ""))) : e instanceof Ds ? r = "" : nr._isUint8Array(e) ? (e = nr._uint8ArrayToBuffer(e), r = "") : e != null && (s = new av("chunk", [
			"string",
			"Buffer",
			"Uint8Array"
		], e))), s) tn(t, s);
			...
			if (i.destroyed || i.errored) return !1;
			i.state &= ~Mn, i.decoder && !r ? (e = i.decoder.write(e), i.objectMode || e.length !== 0 ? Fs(t, i, e, !1) : Qi(t, i)) : Fs(t, i, e, !1);
		}
		else n || (i.state &= ~Mn, Qi(t, i));
		return !i.ended && (i.length < i.highWaterMark || i.length === 0);
	}
	function Fs(t, e, r, n) {
		e.flowing && e.length === 0 && !e.sync && t.listenerCount("data") > 0 ? ((e.state & ld) !== 0 ? e.awaitDrainWriters.clear() : e.awaitDrainWriters = null, e.dataEmitted = !0, t.emit("data", r)) : (e.length += e.objectMode ? 1 : r.length, n ? e.buffer.unshift(r) : e.buffer.push(r), (e.state & Ki) !== 0 && Ji(t)), Qi(t, e);
	}
	le.prototype.isPaused = function() {
		let t = this._readableState;
		return t[xr] === !0 || t.flowing === !1;
	};
	...
	le.prototype.read = function(t) {
		...
		let n = (e.state & Ki) !== 0;
		if (de("need readable", n), (e.length === 0 || e.length - t < e.highWaterMark) && (n = !0, de("length less than watermark", n)), e.ended || e.reading || e.destroyed || e.errored || !e.constructed) n = !1, de("reading, ended or constructing", n);
		else if (n) {
		...
		let i;
		return t > 0 ? i = yd(t, e) : i = null, i === null ? (e.needReadable = e.length <= e.highWaterMark, t = 0) : (e.length -= t, e.multiAwaitDrain ? e.awaitDrainWriters.clear() : e.awaitDrainWriters = null), e.length === 0 && (e.ended || (e.needReadable = !0), r !== t && e.ended && Ws(this)), i !== null && !e.errorEmitted && !e.closeEmitted && (e.dataEmitted = !0, this.emit("data", i)), i;
	};
	function xv(t, e) {
		if (de("onEofChunk"), !e.ended) {
			...
			e.ended = !0, e.sync ? Ji(t) : (e.needReadable = !1, e.emittedReadable = !0, fd(t));
		}
	}
	function Ji(t) {
		let e = t._readableState;
		de("emitReadable", e.needReadable, e.emittedReadable), e.needReadable = !1, e.emittedReadable || (de("emitReadable", e.flowing), e.emittedReadable = !0, lt.nextTick(fd, t));
	}
	function fd(t) {
		let e = t._readableState;
		de("emitReadable_", e.destroyed, e.length, e.ended), !e.destroyed && !e.errored && (e.length || e.ended) && (t.emit("readable"), e.emittedReadable = !1), e.needReadable = !e.flowing && !e.ended && e.length <= e.highWaterMark, dd(t);
	}
	function Qi(t, e) {
		!e.readingMore && e.constructed && (e.readingMore = !0, lt.nextTick(Tv, t, e));
	}
	function Tv(t, e) {
	...
	le.prototype.pipe = function(t, e) {
		...
		n.pipes.length === 1 && (n.multiAwaitDrain || (n.multiAwaitDrain = !0, n.awaitDrainWriters = new J_(n.awaitDrainWriters ? [n.awaitDrainWriters] : []))), n.pipes.push(t), de("pipe count=%d opts=%j", n.pipes.length, e);
		let s = (!e || e.end !== !1) && t !== lt.stdout && t !== lt.stderr ? a : b;
		n.endEmitted ? lt.nextTick(s) : r.once("end", s), t.on("unpipe", o);
		function o(w, _) {
			de("onunpipe"), w === r && _ && _.hasUnpiped === !1 && (_.hasUnpiped = !0, h());
		}
		function a() {
			de("onend"), t.end();
		}
		let c, f = !1;
		function h() {
			de("cleanup"), t.removeListener("close", P), t.removeListener("finish", S), c && t.removeListener("drain", c), t.removeListener("error", g), t.removeListener("unpipe", o), r.removeListener("end", a), r.removeListener("end", b), r.removeListener("data", m), f = !0, c && n.awaitDrainWriters && (!t._writableState || t._writableState.needDrain) && c();
		}
		function d() {
			f || (n.pipes.length === 1 && n.pipes[0] === t ? (de("false write response, pause", 0), n.awaitDrainWriters = t, n.multiAwaitDrain = !1) : n.pipes.length > 1 && n.pipes.includes(t) && (de("false write response, pause", n.awaitDrainWriters.size), n.awaitDrainWriters.add(t)), r.pause()), c || (c = Pv(r, t), t.on("drain", c));
		}
		r.on("data", m);
		function m(w) {
			de("ondata");
			let _ = t.write(w);
			de("dest.write", _), _ === !1 && d();
		}
		function g(w) {
		...
		return t.emit("pipe", r), t.writableNeedDrain === !0 ? d() : n.flowing || (de("pipe resume"), r.resume()), t;
	};
	function Pv(t, e) {
		return function() {
	...
	le.prototype.unpipe = function(t) {
		let e = this._readableState, r = { hasUnpiped: !1 };
		if (e.pipes.length === 0) return this;
		if (!t) {
			let i = e.pipes;
			e.pipes = [], this.pause();
			for (let s = 0; s < i.length; s++) i[s].emit("unpipe", this, { hasUnpiped: !1 });
			return this;
		}
		let n = G_(e.pipes, t);
	...
	le.prototype.on = function(t, e) {
		...
		return t === "data" ? (n.readableListening = this.listenerCount("readable") > 0, n.flowing !== !1 && this.resume()) : t === "readable" && !n.endEmitted && !n.readableListening && (n.readableListening = n.needReadable = !0, n.flowing = !1, n.emittedReadable = !1, de("on readable", n.length, n.reading), n.length ? Ji(this) : n.reading || lt.nextTick(Ov, this)), r;
	};
	...
	function hd(t) {
		let e = t._readableState;
		e.readableListening = t.listenerCount("readable") > 0, e.resumeScheduled && e[xr] === !1 ? e.flowing = !0 : t.listenerCount("data") > 0 ? t.resume() : e.readableListening || (e.flowing = null);
	}
	function Ov(t) {
	...
	le.prototype.resume = function() {
		let t = this._readableState;
		return t.flowing || (de("resume"), t.flowing = !t.readableListening, Rv(this, t)), t[xr] = !1, this;
	};
	function Rv(t, e) {
		e.resumeScheduled || (e.resumeScheduled = !0, lt.nextTick(kv, t, e));
	}
	function kv(t, e) {
		de("resume", e.reading), e.reading || t.read(0), e.resumeScheduled = !1, t.emit("resume"), dd(t), e.flowing && !e.reading && t.read(0);
	}
	le.prototype.pause = function() {
		return de("call pause flowing=%j", this._readableState.flowing), this._readableState.flowing !== !1 && (de("pause"), this._readableState.flowing = !1, this.emit("pause")), this._readableState[xr] = !0, this;
	};
	function dd(t) {
		let e = t._readableState;
	...
	function pd(t, e) {
		typeof t.read != "function" && (t = le.wrap(t, { objectMode: !0 }));
		let r = Cv(t, e);
		return r.stream = t, r;
	}
	async function* Cv(t, e) {
		...
		try {
			...
			(i || e?.destroyOnReturn !== !1) && (i === void 0 || t._readableState.autoDestroy) ? nn.destroyer(t, null) : (t.off("readable", n), s());
		}
	}
	Gs(le.prototype, {
		readable: {
	...
	function Ws(t) {
		let e = t._readableState;
		de("endReadable", e.endEmitted), e.endEmitted || (e.ended = !0, lt.nextTick(Bv, e, t));
	}
	function Bv(t, e) {
		if (de("endReadableNT", t.endEmitted, t.length), !t.errored && !t.closeEmitted && !t.endEmitted && t.length === 0) {
			if (t.endEmitted = !0, e.emit("end"), e.writable && e.allowHalfOpen === !1) lt.nextTick(Mv, e);
...
var ro = j((aC, Od) => {
	...
	function Un(t, e, r) {
		typeof r != "boolean" && (r = e instanceof St()), this.objectMode = !!(t && t.objectMode), r && (this.objectMode = this.objectMode || !!(t && t.writableObjectMode)), this.highWaterMark = t ? Wv(this, t, "writableHighWaterMark", r) : $v(!1), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
		let n = !!(t && t.decodeStrings === !1);
		this.decodeStrings = !n, this.defaultEncoding = t && t.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = Jv.bind(void 0, e), this.writecb = null, this.writelen = 0, this.afterWriteTickInfo = null, eo(this), this.pendingcb = 0, this.constructed = !0, this.prefinished = !1, this.errorEmitted = !1, this.emitClose = !t || t.emitClose !== !1, this.autoDestroy = !t || t.autoDestroy !== !1, this.errored = null, this.closed = !1, this.closeEmitted = !1, this[sn] = [];
	}
	function eo(t) {
	...
	Sd(Un.prototype, "bufferedRequestCount", {
		__proto__: null,
		get() {
	...
	Sd(Ie, Dv, {
		__proto__: null,
		value: function(t) {
			return vd(this, t) ? !0 : this !== Ie ? !1 : t && t._writableState instanceof Un;
		}
	});
	...
	function xd(t, e, r, n) {
		...
		if (!i.objectMode) if (typeof e == "string") i.decodeStrings !== !1 && (e = Xi.from(e, r), r = "buffer");
		else if (e instanceof Xi) r = "buffer";
		else if (qn._isUint8Array(e)) e = qn._uint8ArrayToBuffer(e), r = "buffer";
		else throw new Hv("chunk", [
			"string",
			"Buffer",
			"Uint8Array"
		], e);
		let s;
		return i.ending ? s = new Qv() : i.destroyed && (s = new Ln("write")), s ? (Tr.nextTick(n, s), on(t, s, !0), s) : (i.pendingcb++, Yv(t, i, e, r, n));
	}
	Ie.prototype.write = function(t, e, r) {
		return xd(this, t, e, r) === !0;
	};
	...
	function Yv(t, e, r, n, i) {
		...
		return o || (e.needDrain = !0), e.writing || e.corked || e.errored || !e.constructed ? (e.buffered.push({
			...
			encoding: n,
			callback: i
		}), e.allBuffers && n !== "buffer" && (e.allBuffers = !1), e.allNoop && i !== Qs && (e.allNoop = !1)) : (e.writelen = s, e.writecb = i, e.writing = !0, e.sync = !0, t._write(r, n, e.onwrite), e.sync = !1), o && !e.errored && !e.destroyed;
	}
	function wd(t, e, r, n, i, s, o) {
		e.writelen = n, e.writecb = o, e.writing = !0, e.sync = !0, e.destroyed ? e.onwrite(new Ln("write")) : r ? t._writev(i, e.onwrite) : t._write(i, s, e.onwrite), e.sync = !1;
	}
	function md(t, e, r, n) {
	...
	function Jv(t, e) {
		...
		r.writing = !1, r.writecb = null, r.length -= r.writelen, r.writelen = 0, e ? (e.stack, r.errored || (r.errored = e), t._readableState && !t._readableState.errored && (t._readableState.errored = e), n ? Tr.nextTick(md, t, r, e, i) : md(t, r, e, i)) : (r.buffered.length > r.bufferedIndex && Js(t, r), n ? r.afterWriteTickInfo !== null && r.afterWriteTickInfo.cb === i ? r.afterWriteTickInfo.count++ : (r.afterWriteTickInfo = {
			...
			stream: t,
			state: r
		}, Tr.nextTick(Xv, r.afterWriteTickInfo)) : Td(t, r, 1, i));
	}
	...
	function Js(t, e) {
		...
		if (e.bufferProcessing = !0, s > 1 && t._writev) {
			...
			c.allBuffers = e.allBuffers, wd(t, e, !0, e.length, c, "", a), eo(e);
		} else {
			do {
				let { chunk: a, encoding: c, callback: f } = r[o];
				r[o++] = null;
				wd(t, e, !1, i ? 1 : a.length, a, c, f);
	...
	Ie.prototype.end = function(t, e, r) {
		...
		return n.corked && (n.corked = 1, this.uncork()), i || (!n.errored && !n.ending ? (n.ending = !0, Xs(this, n, !0), n.ended = !0) : n.finished ? i = new zv("end") : n.destroyed && (i = new Ln("end"))), typeof r == "function" && (i || n.finished ? Tr.nextTick(r, i) : n[sn].push(r)), this;
	};
	function Zi(t) {
	...
	function Zv(t, e) {
		...
		function n(i) {
			...
			if (r = !0, e.pendingcb--, i) {
				...
				on(t, i, e.sync);
			} else Zi(e) && (e.prefinished = !0, t.emit("prefinish"), e.pendingcb++, Tr.nextTick(Ks, t, e));
		}
	...
	function Ks(t, e) {
		...
		if (t.emit("finish"), e.autoDestroy) {
			let n = t._readableState;
			(!n || n.autoDestroy && (n.endEmitted || n.readable === !1)) && t.destroy();
		}
	}
	qv(Ie.prototype, {
		closed: {
...
var Hd = j((bC, $d) => {
	...
	$d.exports = function t(e, r) {
		...
		if (Rd(e)) return Ud(ir, e, {
			objectMode: !0,
			writable: !1
		});
		if (Bd(e?.readable) && Md(e?.writable)) return ir.fromWeb(e);
		if (typeof e?.writable == "object" || typeof e?.readable == "object") return an({
			readable: e != null && e.readable ? kd(e?.readable) ? e?.readable : t(e.readable) : void 0,
			writable: e != null && e.writable ? Cd(e?.writable) ? e?.writable : t(e.writable) : void 0
		});
		let n = e?.then;
...
var St = j((TC, zd) => {
	...
	d0(ct.prototype, {
		writable: {
			__proto__: null,
			...Dt(tt.prototype, "writable")
		},
		writableHighWaterMark: {
			__proto__: null,
			...Dt(tt.prototype, "writableHighWaterMark")
		},
		writableObjectMode: {
			__proto__: null,
			...Dt(tt.prototype, "writableObjectMode")
		},
		writableBuffer: {
			__proto__: null,
			...Dt(tt.prototype, "writableBuffer")
		},
		writableLength: {
			__proto__: null,
			...Dt(tt.prototype, "writableLength")
		},
		writableFinished: {
			__proto__: null,
			...Dt(tt.prototype, "writableFinished")
		},
		writableCorked: {
			__proto__: null,
			...Dt(tt.prototype, "writableCorked")
		},
		writableEnded: {
			__proto__: null,
			...Dt(tt.prototype, "writableEnded")
		},
		writableNeedDrain: {
			__proto__: null,
			...Dt(tt.prototype, "writableNeedDrain")
		},
		destroyed: {
			__proto__: null,
			get() {
...
var oa = j((LC, Qd) => {
	...
	function jt(t) {
		...
		let e = t ? b0(this, t, "readableHighWaterMark", !0) : null;
		e === 0 && (t = {
			...t,
			highWaterMark: null,
			readableHighWaterMark: e,
			writableHighWaterMark: t.writableHighWaterMark || 0
		}), ia.call(this, t), this._readableState.sync = !1, this[Dn] = null, t && (typeof t.transform == "function" && (this._transform = t.transform), typeof t.flush == "function" && (this._flush = t.flush)), this.on("prefinish", w0);
	}
	function na(t) {
...
var so = j((nB, rp) => {
	...
	function ep(t, e, r) {
		...
		return {
			destroy: (s) => {
				n || (n = !0, A0.destroyer(t, s || new T0("pipe")));
			},
			cleanup: oo(t, {
				readable: e,
				writable: r
	...
	function tp(t, e, r) {
		...
		let S;
		for (let R = 0; R < t.length; R++) {
			let T = t[R], y = R < t.length - 1, O = R > 0, v = y || r?.end !== !1, M = R === t.length - 1;
			if (Zd(T)) {
				let F = function(U) {
			...
			if (R === 0) if (typeof T == "function") {
				...
				if (S = T(S, { signal: i }), y) {
					if (!Pr(S, !0)) throw new ua("AsyncIterable", `transform[${R - 1}]`, S);
				} else {
					var w;
					fa || (fa = aa());
					let F = new fa({ objectMode: !0 }), U = (w = S) === null || w === void 0 ? void 0 : w.then;
					if (typeof U == "function") m++, U.call(S, (H) => {
						h = H, H != null && F.write(H), v && F.end(), jn.nextTick(g);
					}, (H) => {
						F.destroy(H), jn.nextTick(g, H);
					});
					else if (Pr(S, !0)) m++, no(S, F, g, { end: v });
					else if (ca(S) || cn(S)) {
						let H = S.readable || S;
						m++, no(H, F, g, { end: v });
					} else throw new ua("AsyncIterable or Promise", "destination", S);
					S = F;
					let { destroy: Q, cleanup: W } = ep(S, !1, !0);
					d.push(Q), M && o.push(W);
				}
			} else if (Zd(T)) {
				if (io(S)) {
		...
		if (a = new ao({
			...
			if (uo(f)) a._write = function(P, S, b) {
				...
				a._write = async function(b, w, _) {
					try {
						await S.ready, S.write(b).catch(() => {}), _();
					} catch (R) {
						_(R);
					}
				}, a._final = async function(b) {
					try {
						await S.ready, S.close().catch(() => {}), i = b;
					} catch (w) {
						b(w);
					}
				};
...
var wp = j((EB, va) => {
	...
	function co(t, e) {
		...
		return e?.highWaterMark != null && (n = cp(e.highWaterMark)), lp(r, "options.concurrency", 1), lp(n, "options.highWaterMark", 0), n += r, async function* () {
			let s = $e().AbortSignalAny([e?.signal].filter(nS)), o = this, a = [], c = { signal: s }, f, h, d = !1, m = 0;
			function g() {
				d = !0, P();
			}
			function P() {
	...
	async function gp(t, e = void 0) {
		for await (let r of _a.call(this, t, e)) return !0;
		return !1;
	}
	...
	async function hS(t, e, r) {
		...
		if (r != null && (n = r.signal) !== null && n !== void 0 && n.aborted) {
			...
			throw this.once("error", () => {}), await Y0(this.destroy(f)), f;
		}
		...
		try {
			for await (let f of this) {
				var c;
				if (a = !0, r != null && (c = r.signal) !== null && c !== void 0 && c.aborted) throw new Et();
				i ? e = await t(e, f, { signal: o }) : (e = f, i = !0);
			}
			if (!a && !i) throw new ma();
		} finally {
			s.abort();
	...
	va.exports.streamReturningOperators = {
	...
	va.exports.promiseReturningOperators = {
		every: lS,
		forEach: fS,
		reduce: hS,
		toArray: dS,
...
var or = j((ZB, Pe) => {
	...
	Object.defineProperty(Be, "promises", {
		configurable: !0,
		enumerable: !0,
		get() {
			return kS;
...
var Op = j((lM, Ia) => {
	...
	typeof Object.create == "function" ? Ia.exports = function(e, r) {
		r && (e.super_ = r, e.prototype = Object.create(r.prototype, { constructor: {
			value: e,
			enumerable: !1,
			writable: !0,
			configurable: !0
...
var Cp = j((mM, kp) => {
	...
	we._init = function(e) {
		Object.defineProperty(this, Rp, { value: !0 }), this._bufs = [], this.length = 0, e && this.append(e);
	};
	...
	we.prototype.prepend = function(e) {
		return this._attach(e, we.prototype._prependBuffer, !0);
	};
...
var Pa = j((QM, qp) => {
	...
	K.EMPTY = {
		pingreq: Ke.from([K.codes.pingreq << 4, 0]),
		pingresp: Ke.from([K.codes.pingresp << 4, 0]),
		disconnect: Ke.from([K.codes.disconnect << 4, 0])
	};
...
var jp = j((y2, Dp) => {
	...
	function DS(t) {
		...
		function r(h) {
			...
			function S(...b) {
				if (!S.enabled) return;
				let w = S, _ = Number(/* @__PURE__ */ new Date());
				w.diff = _ - (d || _), w.prev = d, w.curr = _, d = _, b[0] = r.coerce(b[0]), typeof b[0] != "string" && b.unshift("%O");
				let T = 0;
			...
			return S.namespace = h, S.useColors = r.useColors(), S.color = r.selectColor(h), S.extend = n, S.destroy = r.destroy, Object.defineProperty(S, "enabled", {
				enumerable: !0,
				configurable: !1,
				get: () => m !== null ? m : (g !== r.namespaces && (g = r.namespaces, P = r.enabled(h)), P),
				set: (b) => {
					m = b;
				}
		...
		function a(h) {
			for (let d of r.skips) if (s(h, d)) return !1;
			for (let d of r.names) if (s(h, d)) return !0;
			return !1;
		}
		function c(h) {
...
var $p = j((M2, Wp) => {
	...
	x();
	I();
	var GS = Bp(), { EventEmitter: zS } = (er(), me(Zt)), Fp = Np(), pe = Pa(), ae = At()("mqtt-packet:parser");
	Wp.exports = class t extends zS {
		constructor() {
			super(), this.parser = this.constructor.parser;
		}
		static parser(e) {
			return this instanceof t ? (this.settings = e || {}, this._states = [
				"_parseHeader",
				"_parseLength",
				"_parsePayload",
				"_newPacket"
			...
			if (this.packet.length === 0 || this._list.length >= this.packet.length) {
				switch (this._pos = 0, this.packet.cmd) {
					...
					case "auth":
						this._parseAuth();
						break;
					default: this._emitError(/* @__PURE__ */ new Error("Not supported"));
				}
				e = !0;
			}
		...
		_parseConnect() {
			...
			if (a === null) return this._emitError(/* @__PURE__ */ new Error("Cannot parse protocolId"));
			if (a !== "MQTT" && a !== "MQIsdp") return this._emitError(/* @__PURE__ */ new Error("Invalid protocolId"));
			if (o.protocolId = a, this._pos >= this._list.length) return this._emitError(/* @__PURE__ */ new Error("Packet too short"));
			if (o.protocolVersion = this._list.readUInt8(this._pos), o.protocolVersion >= 128 && (o.bridgeMode = !0, o.protocolVersion = o.protocolVersion - 128), o.protocolVersion !== 3 && o.protocolVersion !== 4 && o.protocolVersion !== 5) return this._emitError(/* @__PURE__ */ new Error("Invalid protocol version"));
			if (this._pos++, this._pos >= this._list.length) return this._emitError(/* @__PURE__ */ new Error("Packet too short"));
			if (this._list.readUInt8(this._pos) & 1) return this._emitError(/* @__PURE__ */ new Error("Connect flag bit 0 must be 0, but got 1"));
			...
			if (s.will) o.will = {}, o.will.retain = c, o.will.qos = f;
				...
				if (c) return this._emitError(/* @__PURE__ */ new Error("Will Retain Flag must be set to zero when Will Flag is set to 0"));
				if (f) return this._emitError(/* @__PURE__ */ new Error("Will QoS must be set to zero when Will Flag is set to 0"));
			}
			if (o.clean = (this._list.readUInt8(this._pos) & pe.CLEAN_SESSION_MASK) !== 0, this._pos++, o.keepalive = this._parseNum(), o.keepalive === -1) return this._emitError(/* @__PURE__ */ new Error("Packet too short"));
			...
			if (h === null) return this._emitError(/* @__PURE__ */ new Error("Packet too short"));
			if (o.clientId = h, ae("_parseConnect: packet.clientId: %s", o.clientId), s.will) {
				...
				if (e = this._parseString(), e === null) return this._emitError(/* @__PURE__ */ new Error("Cannot parse will topic"));
				if (o.will.topic = e, ae("_parseConnect: packet.will.topic: %s", o.will.topic), r = this._parseBuffer(), r === null) return this._emitError(/* @__PURE__ */ new Error("Cannot parse will payload"));
				o.will.payload = r, ae("_parseConnect: packet.will.paylaod: %s", o.will.payload);
			}
			if (s.username) {
				if (i = this._parseString(), i === null) return this._emitError(/* @__PURE__ */ new Error("Cannot parse username"));
				o.username = i, ae("_parseConnect: packet.username: %s", o.username);
			}
			if (s.password) {
				if (n = this._parseBuffer(), n === null) return this._emitError(/* @__PURE__ */ new Error("Cannot parse password"));
				o.password = n;
			}
		...
		_parseConnack() {
			...
			if (r > 1) return this._emitError(/* @__PURE__ */ new Error("Invalid connack flags, bits 7-1 must be set to 0"));
			...
			if (e.returnCode === -1 || e.reasonCode === -1) return this._emitError(/* @__PURE__ */ new Error("Cannot parse return code"));
		...
		_parsePublish() {
			ae("_parsePublish");
			let e = this.packet;
			if (e.topic = this._parseString(), e.topic === null) return this._emitError(/* @__PURE__ */ new Error("Cannot parse topic"));
		...
		_parseSubscribe() {
			...
			if (e.subscriptions = [], !!this._parseMessageId()) {
				...
				if (e.length <= 0) return this._emitError(/* @__PURE__ */ new Error("Malformed subscribe, no payload specified"));
				for (; this._pos < e.length;) {
					if (r = this._parseString(), r === null) return this._emitError(/* @__PURE__ */ new Error("Cannot parse topic"));
					if (this._pos >= e.length) return this._emitError(/* @__PURE__ */ new Error("Malformed Subscribe Payload"));
					if (n = this._parseByte(), this.settings.protocolVersion === 5) {
						if (n & 192) return this._emitError(/* @__PURE__ */ new Error("Invalid subscribe topic flag bits, bits 7-6 must be 0"));
					} else if (n & 252) return this._emitError(/* @__PURE__ */ new Error("Invalid subscribe topic flag bits, bits 7-2 must be 0"));
					if (i = n & pe.SUBSCRIBE_OPTIONS_QOS_MASK, i > 2) return this._emitError(/* @__PURE__ */ new Error("Invalid subscribe QoS, must be <= 2"));
					if (a = (n >> pe.SUBSCRIBE_OPTIONS_NL_SHIFT & pe.SUBSCRIBE_OPTIONS_NL_MASK) !== 0, o = (n >> pe.SUBSCRIBE_OPTIONS_RAP_SHIFT & pe.SUBSCRIBE_OPTIONS_RAP_MASK) !== 0, s = n >> pe.SUBSCRIBE_OPTIONS_RH_SHIFT & pe.SUBSCRIBE_OPTIONS_RH_MASK, s > 2) return this._emitError(/* @__PURE__ */ new Error("Invalid retain handling, must be <= 2"));
					c = {
						topic: r,
						qos: i
					}, this.settings.protocolVersion === 5 ? (c.nl = a, c.rap = o, c.rh = s) : this.settings.bridgeMode && (c.rh = 0, c.rap = !0, c.nl = !0), ae("_parseSubscribe: push subscription `%s` to subscription", c), e.subscriptions.push(c);
				}
			}
		}
		_parseSuback() {
			...
			if (this.packet.granted = [], !!this._parseMessageId()) {
				...
				if (e.length <= 0) return this._emitError(/* @__PURE__ */ new Error("Malformed suback, no payload specified"));
				for (; this._pos < this.packet.length;) {
					let r = this._list.readUInt8(this._pos++);
					if (this.settings.protocolVersion === 5) {
						if (!pe.MQTT5_SUBACK_CODES[r]) return this._emitError(/* @__PURE__ */ new Error("Invalid suback code"));
					} else if (r > 2 && r !== 128) return this._emitError(/* @__PURE__ */ new Error("Invalid suback QoS, must be 0, 1, 2 or 128"));
		...
		_parseUnsubscribe() {
			...
			if (e.unsubscriptions = [], !!this._parseMessageId()) {
				...
				if (e.length <= 0) return this._emitError(/* @__PURE__ */ new Error("Malformed unsubscribe, no payload specified"));
				for (; this._pos < e.length;) {
					let r = this._parseString();
					if (r === null) return this._emitError(/* @__PURE__ */ new Error("Cannot parse topic"));
		...
		_parseUnsuback() {
			ae("_parseUnsuback");
			let e = this.packet;
			if (!this._parseMessageId()) return this._emitError(/* @__PURE__ */ new Error("Cannot parse messageId"));
			if ((this.settings.protocolVersion === 3 || this.settings.protocolVersion === 4) && e.length !== 2) return this._emitError(/* @__PURE__ */ new Error("Malformed unsuback, payload length must be 2"));
			if (e.length <= 0) return this._emitError(/* @__PURE__ */ new Error("Malformed unsuback, no payload specified"));
			if (this.settings.protocolVersion === 5) {
				let r = this._parseProperties();
				for (Object.getOwnPropertyNames(r).length && (e.properties = r), e.granted = []; this._pos < this.packet.length;) {
					...
					if (!pe.MQTT5_UNSUBACK_CODES[n]) return this._emitError(/* @__PURE__ */ new Error("Invalid unsuback code"));
			...
			if (this._parseMessageId(), this.settings.protocolVersion === 5) {
				if (e.length > 2) {
					switch (e.reasonCode = this._parseByte(), this.packet.cmd) {
						case "puback":
						case "pubrec":
							if (!pe.MQTT5_PUBACK_PUBREC_CODES[e.reasonCode]) return this._emitError(/* @__PURE__ */ new Error("Invalid " + this.packet.cmd + " reason code"));
							break;
						case "pubrel":
						case "pubcomp":
							if (!pe.MQTT5_PUBREL_PUBCOMP_CODES[e.reasonCode]) return this._emitError(/* @__PURE__ */ new Error("Invalid " + this.packet.cmd + " reason code"));
							break;
					}
		...
		_parseDisconnect() {
			...
			if (ae("_parseDisconnect"), this.settings.protocolVersion === 5) {
				this._list.length > 0 ? (e.reasonCode = this._parseByte(), pe.MQTT5_DISCONNECT_CODES[e.reasonCode] || this._emitError(/* @__PURE__ */ new Error("Invalid disconnect reason code"))) : e.reasonCode = 0;
				let r = this._parseProperties();
				Object.getOwnPropertyNames(r).length && (e.properties = r);
			}
			return ae("_parseDisconnect result: true"), !0;
		}
		_parseAuth() {
			ae("_parseAuth");
			let e = this.packet;
			if (this.settings.protocolVersion !== 5) return this._emitError(/* @__PURE__ */ new Error("Not supported auth packet for this version MQTT"));
			if (e.reasonCode = this._parseByte(), !pe.MQTT5_AUTH_CODES[e.reasonCode]) return this._emitError(/* @__PURE__ */ new Error("Invalid auth reason code"));
			let r = this._parseProperties();
			return Object.getOwnPropertyNames(r).length && (e.properties = r), ae("_parseAuth: result: true"), !0;
		}
		_parseMessageId() {
			let e = this.packet;
			return e.messageId = this._parseNum(), e.messageId === null ? (this._emitError(/* @__PURE__ */ new Error("Cannot parse messageId")), !1) : (ae("_parseMessageId: packet.messageId %d", e.messageId), !0);
		}
		_parseString(e) {
		...
		_parseVarByteNum(e) {
			ae("_parseVarByteNum");
			let r = 4, n = 0, i = 1, s = 0, o = !1, a, c = this._pos ? this._pos : 0;
			...
			return !o && n === r && this._list.length >= n && this._emitError(/* @__PURE__ */ new Error("Invalid variable byte integer")), c && (this._pos += n), o ? e ? o = {
				bytes: n,
				value: s
			} : o = s : o = !1, ae("_parseVarByteNum: result: %o", o), o;
		}
		_parseByte() {
			let e;
		...
		_parseProperties() {
			...
			for (; this._pos < n;) {
				...
				if (!s) return this._emitError(/* @__PURE__ */ new Error("Cannot parse property code type")), !1;
				let o = pe.propertiesCodes[s];
				if (!o) return this._emitError(/* @__PURE__ */ new Error("Unknown property")), !1;
				if (o === "userProperties") {
		...
		_newPacket() {
			return ae("_newPacket"), this.packet && (this._list.consume(this.packet.length), ae("_newPacket: parser emit packet: packet.cmd: %s, packet.payload: %s, packet.length: %d", this.packet.cmd, this.packet.payload, this.packet.length), this.emit("packet", this.packet)), ae("_newPacket: new packet"), this.packet = new Fp(), this._pos = 0, !0;
		}
		_emitError(e) {
...
var Kp = j((eN, Ra) => {
	...
	function ZS(t, e, r, n) {
		...
		switch (i) {
			case 0:
			case 1: return N.nextTick(t);
			case 2: return N.nextTick(function() {
				t.call(null, e);
			});
			case 3: return N.nextTick(function() {
				t.call(null, e, r);
			});
			case 4: return N.nextTick(function() {
				t.call(null, e, r, n);
			});
			default:
...
var Ba = j((cN, ry) => {
	...
	x();
	I();
	var ue = Pa(), { Buffer: se } = (ke(), me(qe)), eE = se.allocUnsafe(0), tE = se.from([0]), Vn = zp(), rE = Kp().nextTick, rt = At()("mqtt-packet:writeToStream"), yo = Vn.cache, nE = Vn.generateNumber, iE = Vn.generateCache, ka = Vn.genBufVariableByteInt, oE = Vn.generate4ByteBuffer, He = Ca, go = !0;
	function ey(t, e, r) {
		switch (rt("generate called"), e.cork && (e.cork(), rE(sE, e)), go && (go = !1, iE()), rt("generate: packet.cmd: %s", t.cmd), t.cmd) {
			case "connect": return aE(t, e, r);
			case "connack": return uE(t, e, r);
			case "publish": return lE(t, e, r);
			case "puback":
			case "pubrec":
			case "pubrel":
			case "pubcomp": return cE(t, e, r);
			case "subscribe": return fE(t, e, r);
			case "suback": return hE(t, e, r);
			case "unsubscribe": return dE(t, e, r);
			case "unsuback": return pE(t, e, r);
			case "pingreq":
			case "pingresp": return yE(t, e, r);
			case "disconnect": return gE(t, e, r);
			case "auth": return bE(t, e, r);
			default: return e.destroy(/* @__PURE__ */ new Error("Unknown command")), !1;
		}
	}
	Object.defineProperty(ey, "cacheNumbers", {
		get() {
			return He === Ca;
		},
		set(t) {
			t ? ((!yo || Object.keys(yo).length === 0) && (go = !0), He = Ca) : (go = !1, He = wE);
		}
	});
	function sE(t) {
		t.uncork();
	...
	function aE(t, e, r) {
		...
		a === void 0 && (a = !0);
		let g = 0;
		if (!i || typeof i != "string" && !se.isBuffer(i)) return e.destroy(/* @__PURE__ */ new Error("Invalid protocolId")), !1;
		if (g += i.length + 2, s !== 3 && s !== 4 && s !== 5) return e.destroy(/* @__PURE__ */ new Error("Invalid protocol version")), !1;
		if (g += 1, (typeof f == "string" || se.isBuffer(f)) && (f || s >= 4) && (f || a)) g += se.byteLength(f) + 2;
		else {
			if (s < 4) return e.destroy(/* @__PURE__ */ new Error("clientId must be supplied before 3.1.1")), !1;
			if (a * 1 === 0) return e.destroy(/* @__PURE__ */ new Error("clientId must be given if cleanSession set to 0")), !1;
		}
		if (typeof c != "number" || c < 0 || c > 65535 || c % 1 !== 0) return e.destroy(/* @__PURE__ */ new Error("Invalid keepalive")), !1;
		g += 2, g += 1;
		let P, S;
		if (s === 5) {
			if (P = ar(e, m), !P) return !1;
			g += P.length;
		}
		if (o) {
			if (typeof o != "object") return e.destroy(/* @__PURE__ */ new Error("Invalid will")), !1;
			if (!o.topic || typeof o.topic != "string") return e.destroy(/* @__PURE__ */ new Error("Invalid will topic")), !1;
			...
			else return e.destroy(/* @__PURE__ */ new Error("Invalid will payload")), !1;
			if (S = {}, s === 5) {
				if (S = ar(e, o.properties), !S) return !1;
				g += S.length;
			}
		}
		let b = !1;
		if (h != null) if (Zp(h)) b = !0, g += se.byteLength(h) + 2;
		else return e.destroy(/* @__PURE__ */ new Error("Invalid username")), !1;
		if (d != null) {
			if (!b) return e.destroy(/* @__PURE__ */ new Error("Username is required to use password")), !1;
			if (Zp(d)) g += ty(d) + 2;
			else return e.destroy(/* @__PURE__ */ new Error("Invalid password")), !1;
		}
	...
	function lE(t, e, r) {
		...
		else return e.destroy(/* @__PURE__ */ new Error("Invalid topic")), !1;
		if (se.isBuffer(c) ? d += c.length : d += se.byteLength(c), s && typeof f != "number") return e.destroy(/* @__PURE__ */ new Error("Invalid messageId")), !1;
		s && (d += 2);
		let m = null;
		if (n === 5) {
			if (m = ar(e, h), !m) return !1;
			d += m.length;
		}
	...
	function cE(t, e, r) {
		...
		if (s === "pubrel" && (c = 1), typeof o != "number") return e.destroy(/* @__PURE__ */ new Error("Invalid messageId")), !1;
		let m = null;
		if (n === 5 && typeof h == "object") {
			if (m = Gn(e, h, r, d), !m) return !1;
			d += m.length;
		}
		return e.write(ue.ACKS[s][c][a][0]), d === 3 && (d += f !== 0 ? 1 : -1), nt(e, d), He(e, o), n === 5 && d !== 2 && e.write(se.from([f])), m !== null ? m.write() : d === 4 && e.write(se.from([0])), !0;
	}
	function fE(t, e, r) {
		rt("subscribe: packet: ");
		let n = r ? r.protocolVersion : 4, i = t || {}, s = i.dup ? ue.DUP_MASK : 0, o = i.messageId, a = i.subscriptions, c = i.properties, f = 0;
		if (typeof o != "number") return e.destroy(/* @__PURE__ */ new Error("Invalid messageId")), !1;
		f += 2;
		let h = null;
		if (n === 5) {
			if (h = ar(e, c), !h) return !1;
			f += h.length;
		}
		if (typeof a == "object" && a.length) for (let m = 0; m < a.length; m += 1) {
			let g = a[m].topic, P = a[m].qos;
			if (typeof g != "string") return e.destroy(/* @__PURE__ */ new Error("Invalid subscriptions - invalid topic")), !1;
			if (typeof P != "number") return e.destroy(/* @__PURE__ */ new Error("Invalid subscriptions - invalid qos")), !1;
			if (n === 5) {
				if (typeof (a[m].nl || !1) != "boolean") return e.destroy(/* @__PURE__ */ new Error("Invalid subscriptions - invalid No Local")), !1;
				if (typeof (a[m].rap || !1) != "boolean") return e.destroy(/* @__PURE__ */ new Error("Invalid subscriptions - invalid Retain as Published")), !1;
				let w = a[m].rh || 0;
				if (typeof w != "number" || w > 2) return e.destroy(/* @__PURE__ */ new Error("Invalid subscriptions - invalid Retain Handling")), !1;
			}
			f += se.byteLength(g) + 2 + 1;
		}
		else return e.destroy(/* @__PURE__ */ new Error("Invalid subscriptions")), !1;
	...
	function hE(t, e, r) {
		...
		if (typeof s != "number") return e.destroy(/* @__PURE__ */ new Error("Invalid messageId")), !1;
		if (c += 2, typeof o == "object" && o.length) for (let h = 0; h < o.length; h += 1) {
			if (typeof o[h] != "number") return e.destroy(/* @__PURE__ */ new Error("Invalid qos vector")), !1;
			c += 1;
		}
		else return e.destroy(/* @__PURE__ */ new Error("Invalid qos vector")), !1;
		let f = null;
		if (n === 5) {
			if (f = Gn(e, a, r, c), !f) return !1;
			c += f.length;
		}
	...
	function dE(t, e, r) {
		...
		if (f += 2, typeof a == "object" && a.length) for (let m = 0; m < a.length; m += 1) {
			if (typeof a[m] != "string") return e.destroy(/* @__PURE__ */ new Error("Invalid unsubscriptions")), !1;
			f += se.byteLength(a[m]) + 2;
		}
		else return e.destroy(/* @__PURE__ */ new Error("Invalid unsubscriptions")), !1;
		let h = null;
		if (n === 5) {
			if (h = ar(e, c), !h) return !1;
			f += h.length;
	...
	function pE(t, e, r) {
		...
		if (n === 5) if (typeof a == "object" && a.length) for (let g = 0; g < a.length; g += 1) {
			if (typeof a[g] != "number") return e.destroy(/* @__PURE__ */ new Error("Invalid qos vector")), !1;
			d += 1;
		}
		else return e.destroy(/* @__PURE__ */ new Error("Invalid qos vector")), !1;
		let m = null;
		if (n === 5) {
			if (m = Gn(e, c, r, d), !m) return !1;
			d += m.length;
		}
		return e.write(ue.ACKS[f][h][o][0]), nt(e, d), He(e, s), m !== null && m.write(), n === 5 && e.write(se.from(a)), !0;
	}
	function yE(t, e, r) {
	...
	function gE(t, e, r) {
		...
		if (n === 5) {
			if (c = Gn(e, o, r, a), !c) return !1;
			a += c.length;
		}
		return e.write(se.from([ue.codes.disconnect << 4])), nt(e, a), n === 5 && e.write(se.from([s])), c !== null && c.write(), !0;
	}
	function bE(t, e, r) {
		let n = r ? r.protocolVersion : 4, i = t || {}, s = i.reasonCode, o = i.properties, a = n === 5 ? 1 : 0;
		n !== 5 && e.destroy(/* @__PURE__ */ new Error("Invalid mqtt version for auth packet"));
		let c = Gn(e, o, r, a);
		return c ? (a += c.length, e.write(se.from([ue.codes.auth << 4])), nt(e, a), e.write(se.from([s])), c !== null && c.write(), !0) : !1;
	}
	var Qp = {};
	function nt(t, e) {
		if (e > ue.VARBYTEINT_MAX) return t.destroy(/* @__PURE__ */ new Error(`Invalid variable byte integer: ${e}`)), !1;
		let r = Qp[e];
	...
	function ar(t, e) {
		...
		function n(s, o) {
			...
			switch (a) {
				case "byte":
					if (typeof o != "boolean") return t.destroy(/* @__PURE__ */ new Error(`Invalid ${s}: ${o}`)), !1;
					c += 2;
					break;
				case "int8":
					if (typeof o != "number" || o < 0 || o > 255) return t.destroy(/* @__PURE__ */ new Error(`Invalid ${s}: ${o}`)), !1;
					c += 2;
					break;
				case "binary":
					if (o && o === null) return t.destroy(/* @__PURE__ */ new Error(`Invalid ${s}: ${o}`)), !1;
					c += 1 + se.byteLength(o) + 2;
					break;
				case "int16":
					if (typeof o != "number" || o < 0 || o > 65535) return t.destroy(/* @__PURE__ */ new Error(`Invalid ${s}: ${o}`)), !1;
					c += 3;
					break;
				case "int32":
					if (typeof o != "number" || o < 0 || o > 4294967295) return t.destroy(/* @__PURE__ */ new Error(`Invalid ${s}: ${o}`)), !1;
					c += 5;
					break;
				case "var":
					if (typeof o != "number" || o < 0 || o > 268435455) return t.destroy(/* @__PURE__ */ new Error(`Invalid ${s}: ${o}`)), !1;
					c += 1 + se.byteLength(ka(o));
					break;
				case "string":
					if (typeof o != "string") return t.destroy(/* @__PURE__ */ new Error(`Invalid ${s}: ${o}`)), !1;
					c += 3 + se.byteLength(o.toString());
					break;
				case "pair":
					if (typeof o != "object") return t.destroy(/* @__PURE__ */ new Error(`Invalid ${s}: ${o}`)), !1;
					...
					break;
				default: return t.destroy(/* @__PURE__ */ new Error(`Invalid property ${s}: ${o}`)), !1;
			}
			return c;
		}
		if (e) for (let s in e) {
			...
			if (c !== void 0) {
				if (Array.isArray(c)) for (let f = 0; f < c.length; f++) {
					if (a = n(s, c[f]), !a) return !1;
					o += a;
				}
				else {
					if (a = n(s, c), !a) return !1;
					o = a;
				}
				if (!o) return !1;
				r += o;
	...
	function Jp(t, e, r) {
		switch (ue.propertiesTypes[e]) {
			...
			case "pair":
				...
				break;
			default: return t.destroy(/* @__PURE__ */ new Error(`Invalid property ${e} value: ${r}`)), !1;
		}
	}
	function Xp(t, e, r) {
		nt(t, r);
...
var Ua = j((La) => {
	...
	var xE = or(), TE = { objectMode: !0 }, PE = { clean: !0 }, qa = class {
		options;
		_inflights;
		constructor(e) {
		...
		createStream() {
			let e = new xE.Readable(TE), r = [], n = !1, i = 0;
		...
		del(e, r) {
			...
			return n ? (this._inflights.delete(e.messageId), r(null, n)) : r && r(/* @__PURE__ */ new Error("missing packet")), this;
		}
		get(e, r) {
			let n = this._inflights.get(e.messageId);
			return n ? r(null, n) : r && r(/* @__PURE__ */ new Error("missing packet")), this;
		}
		close(e) {
		...
		if (t.options.protocolVersion === 5) {
			...
			if (e.properties && (c = e.properties.topicAlias), typeof c < "u") if (n.length === 0) if (c > 0 && c <= 65535) {
				...
				if (f) n = f, t.log("handlePublish :: topic complemented by alias. topic: %s - alias: %d", n, c);
					...
					t.log("handlePublish :: unregistered topic alias. alias: %d", c), t.emit("error", /* @__PURE__ */ new Error("Received unregistered Topic Alias"));
					return;
				}
			} else {
				t.log("handlePublish :: topic alias out of range. alias: %d", c), t.emit("error", /* @__PURE__ */ new Error("Received Topic Alias is out of range"));
				return;
			}
		...
		switch (t.log("handlePublish: qos %d", s), s) {
			case 2:
				a.customHandleAcks(n, i, e, (c, f) => {
					...
					if (hy.indexOf(f) === -1) return t.emit("error", /* @__PURE__ */ new Error("Wrong reason code for pubrec"));
					f ? t._sendPacket({
						cmd: "pubrec",
						messageId: o,
						reasonCode: f
			...
			case 1:
				a.customHandleAcks(n, i, e, (c, f) => {
					if (typeof c == "number" && (f = c, c = null), c) return t.emit("error", c);
					if (hy.indexOf(f) === -1) return t.emit("error", /* @__PURE__ */ new Error("Wrong reason code for puback"));
...
var Mr = j((ht) => {
	...
	function kE(t, e, r = !1) {
		...
		for (let i of n) for (let s of Object.getOwnPropertyNames(i.prototype)) (r || s !== "constructor") && Object.defineProperty(t.prototype, s, Object.getOwnPropertyDescriptor(i.prototype, s) ?? Object.create(null));
	}
		...
		switch (t.log("_handleAck :: packet type", n), n) {
			...
			case "suback": {
				...
				for (let c = 0; c < a.length; c++) {
					let f = a[c];
					if ((f & 128) !== 0) {
						o = /* @__PURE__ */ new Error(`Subscribe error: ${ur.ReasonCodes[f]}`), o.code = f;
			...
			case "unsuback":
				...
				break;
			default: t.emit("error", /* @__PURE__ */ new Error("unrecognized packet type"));
		}
...
var by = j((Wa) => {
	...
	var gy = Mr(), BE = zn(), ME = (t, e) => {
		...
		t.handleAuth(e, (s, o) => {
			...
			if (i === 24) t.reconnecting = !1, t._sendPacket(o);
			else {
...
var Sy = j((_o) => {
	...
	if (typeof mo > "u") {
		...
		let t = $a.env?.LRU_CACHE_IGNORE_AC_WARNING !== "1", e = () => {
			t && (t = !1, _y("AbortController is not defined. If using lru-cache in node 14, load an AbortController polyfill from the `node-abort-controller` package. A minimal polyfill is provided for use by LRUCache.fetch(), but it should not be relied upon in other contexts (eg, passing it to other APIs that use AbortController/AbortSignal might have undesirable effects). You may disable this with LRU_CACHE_IGNORE_AC_WARNING=1 in the env.", "NO_ABORT_CONTROLLER", "ENOTSUP", e));
		};
	}
	var NE = (t) => !my.has(t), lr = (t) => t && t === Math.floor(t) && t > 0 && isFinite(t), vy = (t) => lr(t) ? t <= Math.pow(2, 8) ? Uint8Array : t <= Math.pow(2, 16) ? Uint16Array : t <= Math.pow(2, 32) ? Uint32Array : t <= Number.MAX_SAFE_INTEGER ? bn : null : null, bn = class extends Array {
		constructor(e) {
			super(e), this.fill(0);
		}
	}, Ha = class t {
	...
	_o.LRUCache = class t {
		...
		static unsafeExposeInternals(e) {
			return {
				...
				backgroundFetch: (r, n, i, s) => e.#M(r, n, i, s),
				moveToTail: (r) => e.#O(r),
				indexes: (r) => e.#S(r),
				rindexes: (r) => e.#E(r),
				isStale: (r) => e.#p(r)
		...
		getRemainingTTL(e) {
			return this.#n.has(e) ? Infinity : 0;
		}
		#N() {
		...
		*rvalues() {
		...
		purgeStale() {
			let e = !1;
			for (let r of this.#E({ allowStale: !0 })) this.#p(r) && (this.#A(this.#r[r], "expire"), e = !0);
			return e;
		}
		info(e) {
			let r = this.#n.get(e);
			...
			if (this.#d && this.#_) {
				...
				if (o && a) s.ttl = o - (gn.now() - a), s.start = Date.now();
			}
		...
		set(e, r, n = {}) {
			...
			if (this.maxEntrySize && h > this.maxEntrySize) return c && (c.set = "miss", c.maxEntrySizeExceeded = !0), this.#A(e, "set"), this;
			let d = this.#i === 0 ? void 0 : this.#n.get(e);
			if (d === void 0) d = this.#i === 0 ? this.#o : this.#w.length !== 0 ? this.#w.pop() : this.#i === this.#u ? this.#B(!1) : this.#i, this.#r[d] = e, this.#e[d] = r, this.#n.set(e, d), this.#l[this.#o] = d, this.#h[d] = this.#o, this.#o = d, this.#i++, this.#C(d, h, c), c && (c.set = "add"), f = !1;
			else {
				this.#O(d);
				let m = this.#e[d];
				if (r !== m) {
					if (this.#x && this.#t(m)) {
						m.__abortController.abort(/* @__PURE__ */ new Error("replaced"));
						let { __staleWhileFetching: g } = m;
						g !== void 0 && !o && (this.#v && this.#y?.(g, e, "set"), this.#c && this.#s?.push([
							g,
							e,
							"set"
						]));
					} else o || (this.#v && this.#y?.(m, e, "set"), this.#c && this.#s?.push([
						m,
						e,
						"set"
					]));
		...
		#B(e) {
			...
			return this.#x && this.#t(i) ? i.__abortController.abort(/* @__PURE__ */ new Error("evicted")) : (this.#v || this.#c) && (this.#v && this.#y?.(i, n, "evict"), this.#c && this.#s?.push([
				i,
				n,
				"evict"
			])), this.#P(r), e && (this.#r[r] = void 0, this.#e[r] = void 0, this.#w.push(r)), this.#i === 1 ? (this.#a = this.#o = 0, this.#w.length = 0) : this.#a = this.#l[r], this.#n.delete(n), this.#i--, r;
		}
		has(e, r = {}) {
			...
			if (s !== void 0) {
				...
				else return n && this.#T(s), i && (i.has = "hit", this.#I(i, s)), !0;
			} else i && (i.has = "miss");
			return !1;
		}
		peek(e, r = {}) {
		...
		#M(e, r, n, i) {
			...
			let c = {
				...
				if (n.status && (w && !b ? (n.status.fetchAborted = !0, n.status.fetchError = o.signal.reason, _ && (n.status.fetchAbortIgnored = !0)) : n.status.fetchResolved = !0), w && !_ && !b) return d(o.signal.reason);
				let R = g;
				return this.#e[r] === g && (S === void 0 ? R.__staleWhileFetching ? this.#e[r] = R.__staleWhileFetching : this.#A(e, "fetch") : (n.status && (n.status.fetchUpdated = !0), this.set(e, S, c.options))), S;
			}, h = (S) => (n.status && (n.status.fetchRejected = !0, n.status.fetchError = S), d(S)), d = (S) => {
				let { aborted: b } = o.signal, w = b && n.allowStaleOnFetchAbort, _ = w || n.allowStaleOnFetchRejection, R = _ || n.noDeleteOnFetchRejection, T = g;
				if (this.#e[r] === g && (!R || T.__staleWhileFetching === void 0 ? this.#A(e, "fetch") : w || (this.#e[r] = T.__staleWhileFetching)), _) return n.status && T.__staleWhileFetching !== void 0 && (n.status.returnedStale = !0), T.__staleWhileFetching;
				if (T.__returned === T) throw S;
			}, m = (S, b) => {
				let w = this.#R?.(e, s, c);
				w && w instanceof Promise && w.then((_) => S(_ === void 0 ? void 0 : _), b), o.signal.addEventListener("abort", () => {
					(!n.ignoreFetchAbort || n.allowStaleOnFetchAbort) && (S(void 0), n.allowStaleOnFetchAbort && (S = (_) => f(_, !0)));
				});
			};
			n.status && (n.status.fetchDispatched = !0);
			let g = new Promise(m).then(f, h), P = Object.assign(g, {
				__abortController: o,
				__staleWhileFetching: s,
				__returned: void 0
			});
			return r === void 0 ? (this.set(e, P, {
				...c.options,
				status: void 0
			}), r = this.#n.get(e)) : this.#e[r] = P, P;
		}
		#t(e) {
			if (!this.#x) return !1;
			let r = e;
		...
		async fetch(e, r = {}) {
			...
			if (T === void 0) {
				...
				if (this.#t(y)) {
					...
					return w && (w.fetch = "inflight", U && (w.returnedStale = !0)), U ? y.__staleWhileFetching : y.__returned = y;
				}
				let O = this.#p(T);
				if (!b && !O) return w && (w.fetch = "hit"), this.#O(T), i && this.#T(T), w && this.#I(w, T), y;
				let v = this.#M(e, T, R, S), F = v.__staleWhileFetching !== void 0 && n;
				return w && (w.fetch = O ? "stale" : "refresh", F && O && (w.returnedStale = !0)), F ? v.__staleWhileFetching : v.__returned = v;
			}
		}
		...
		get(e, r = {}) {
			...
			if (a !== void 0) {
				...
				return o && this.#I(o, a), this.#p(a) ? (o && (o.get = "stale"), f ? (o && n && c.__staleWhileFetching !== void 0 && (o.returnedStale = !0), n ? c.__staleWhileFetching : void 0) : (s || this.#A(e, "expire"), o && n && (o.returnedStale = !0), n ? c : void 0)) : (o && (o.get = "hit"), f ? c.__staleWhileFetching : (this.#O(a), i && this.#T(a), c));
			} else o && (o.get = "miss");
		}
		#D(e, r) {
		...
		#A(e, r) {
			...
			if (this.#i !== 0) {
				let i = this.#n.get(e);
				if (i !== void 0) if (n = !0, this.#i === 1) this.#j(r);
				else {
					this.#P(i);
					let s = this.#e[i];
					if (this.#t(s) ? s.__abortController.abort(/* @__PURE__ */ new Error("deleted")) : (this.#v || this.#c) && (this.#v && this.#y?.(s, e, r), this.#c && this.#s?.push([
						s,
						e,
						r
					])), this.#n.delete(e), this.#r[i] = void 0, this.#e[i] = void 0, i === this.#o) this.#o = this.#h[i];
		...
		#j(e) {
			for (let r of this.#E({ allowStale: !0 })) {
				let n = this.#e[r];
				if (this.#t(n)) n.__abortController.abort(/* @__PURE__ */ new Error("deleted"));
				else {
					let i = this.#r[r];
					this.#v && this.#y?.(n, i, e), this.#c && this.#s?.push([
						n,
						i,
						e
					]);
...
var It = j((cr) => {
	...
	x();
	I();
	Object.defineProperty(cr, "t", { value: !0 });
...
var Ey = j((So) => {
	...
	x();
	I();
	Object.defineProperty(So, "t", { value: !0 });
	So.default = void 0;
...
var Ay = j((Eo) => {
	...
	x();
	I();
	Object.defineProperty(Eo, "t", { value: !0 });
	Eo.default = void 0;
...
var Iy = j((Ao) => {
	...
	x();
	I();
	Object.defineProperty(Ao, "t", { value: !0 });
	Ao.default = void 0;
...
var xo = j((Io) => {
	...
	x();
	I();
	Object.defineProperty(Io, "t", { value: !0 });
	Io.default = void 0;
...
var xt = j((Xa) => {
	...
	x();
	I();
	Object.defineProperty(Xa, "t", { value: !0 });
...
var eu = j((Po) => {
	...
	x();
	I();
	Object.defineProperty(Po, "t", { value: !0 });
...
var xy = j((Oo) => {
	...
	x();
	I();
	Object.defineProperty(Oo, "t", { value: !0 });
	Oo.default = void 0;
	var GE = KE(xo()), zE = eu();
	function KE(t) {
...
var Ty = j((Ro) => {
	...
	x();
	I();
	Object.defineProperty(Ro, "t", { value: !0 });
	Ro.default = void 0;
...
var Py = j((ko) => {
	...
	x();
	I();
	Object.defineProperty(ko, "t", { value: !0 });
	ko.default = void 0;
	var e1 = r1(xo()), t1 = eu();
	function r1(t) {
		return t && t.t ? t : { default: t };
...
var su = j((Bo) => {
	...
	x();
	I();
	Object.defineProperty(Bo, "t", { value: !0 });
	Bo.default = void 0;
	var Ry = Oy(), i1 = It(), ky = xt(), ou = class extends i1.Container {
			...
			for (;;) {
				...
				if (r === n.U) {
					...
					if (i && i.ee === 1) {
						...
						return e.tt = n.tt, r.tt = e, n.tt = e, n.ee = 1, {
							parentNode: r,
							grandParent: n,
							curNode: e
						};
		...
		updateKeyByIterator(e, r) {
			let n = e.o;
			if (n === this.h && (0, ky.throwIteratorAccessError)(), this.i === 1) return n.u = r, !0;
...
var uu = j((No) => {
	...
	x();
	I();
	Object.defineProperty(No, "t", { value: !0 });
	No.default = void 0;
...
var By = j((qo) => {
	...
	x();
	I();
	Object.defineProperty(qo, "t", { value: !0 });
	qo.default = void 0;
	...
	var dt = class t extends l1.default {
		...
		*K(e) {
		...
		find(e) {
			return new dt(this.I(this.Y, e), this.h, this);
		}
		lowerBound(e) {
			return new dt(this.X(this.Y, e), this.h, this);
		}
		upperBound(e) {
			return new dt(this.Z(this.Y, e), this.h, this);
		}
		reverseLowerBound(e) {
			return new dt(this.$(this.Y, e), this.h, this);
		}
		reverseUpperBound(e) {
			return new dt(this.rr(this.Y, e), this.h, this);
		}
		union(e) {
			let r = this;
...
var Ny = j((Lo) => {
	...
	x();
	I();
	Object.defineProperty(Lo, "t", { value: !0 });
	Lo.default = void 0;
	...
	var pt = class t extends d1.default {
		...
		*K(e) {
		...
		lowerBound(e) {
			return new pt(this.X(this.Y, e), this.h, this);
		}
		upperBound(e) {
			return new pt(this.Z(this.Y, e), this.h, this);
		}
		reverseLowerBound(e) {
			return new pt(this.$(this.Y, e), this.h, this);
		}
		reverseUpperBound(e) {
			return new pt(this.rr(this.Y, e), this.h, this);
		}
		setElement(e, r, n) {
			return this.M(e, r, n);
		}
		find(e) {
			return new pt(this.I(this.Y, e), this.h, this);
		}
		getElementByKey(e) {
...
var hu = j((fu) => {
	...
	x();
	I();
	Object.defineProperty(fu, "t", { value: !0 });
	fu.default = g1;
	function g1(t) {
		let e = typeof t;
...
var Uy = j((Uo) => {
	...
	x();
	I();
	Object.defineProperty(Uo, "t", { value: !0 });
	Uo.default = void 0;
	var Ly = gu(), w1 = xt(), Dr = class t extends Ly.HashContainerIterator {
		...
		find(e, r) {
			return new Dr(this.I(e, r), this.h, this);
		}
		forEach(e) {
			let r = 0, n = this.p;
...
var jy = j((Do) => {
	...
	x();
	I();
	Object.defineProperty(Do, "t", { value: !0 });
	Do.default = void 0;
	...
	var jr = class t extends Dy.HashContainerIterator {
		...
		find(e, r) {
			return new jr(this.I(e, r), this.h, this);
		}
		forEach(e) {
			let r = 0, n = this.p;
...
var Fy = j((it) => {
	...
	x();
	I();
	Object.defineProperty(it, "t", { value: !0 });
	Object.defineProperty(it, "Deque", {
		enumerable: !0,
		get: function() {
			return O1.default;
		}
	});
	Object.defineProperty(it, "HashMap", {
		enumerable: !0,
		get: function() {
			return B1.default;
		}
	});
	Object.defineProperty(it, "HashSet", {
		enumerable: !0,
		get: function() {
			return C1.default;
		}
	});
	Object.defineProperty(it, "LinkList", {
		enumerable: !0,
		get: function() {
			return P1.default;
		}
	});
	Object.defineProperty(it, "OrderedMap", {
		enumerable: !0,
		get: function() {
			return k1.default;
		}
	});
	Object.defineProperty(it, "OrderedSet", {
		enumerable: !0,
		get: function() {
			return R1.default;
		}
	});
	Object.defineProperty(it, "PriorityQueue", {
		enumerable: !0,
		get: function() {
			return x1.default;
		}
	});
	Object.defineProperty(it, "Queue", {
		enumerable: !0,
		get: function() {
			return I1.default;
		}
	});
	Object.defineProperty(it, "Stack", {
		enumerable: !0,
		get: function() {
			return A1.default;
		}
	});
	Object.defineProperty(it, "Vector", {
		enumerable: !0,
		get: function() {
			return T1.default;
		}
...
var $y = j((cj, Wy) => {
	...
	Ot.prototype.use = function(t) {
		...
		if (!r.equals(this.ss.end())) {
			...
			return r.pointer.equals(e) ? (this.ss.eraseElementByIterator(r), Pt("use():" + t), !0) : n > t ? !1 : n === t ? (this.ss.updateKeyByIterator(r, new Ve(n + 1, i)), Pt("use():" + t), !0) : i === t ? (this.ss.updateKeyByIterator(r, new Ve(n, i - 1)), Pt("use():" + t), !0) : (this.ss.updateKeyByIterator(r, new Ve(t + 1, i)), this.ss.insert(new Ve(n, t - 1)), Pt("use():" + t), !0);
		}
		return Pt("use():failed"), !1;
	};
...
var Gy = j((Qn) => {
	...
	var j1 = zn(), F1 = D1(Vy()), W1 = Mr(), $1 = (t, e) => {
		...
		if (clearTimeout(t.connackTimer), delete t.topicAliasSend, e.properties) {
			if (e.properties.topicAliasMaximum) {
				if (e.properties.topicAliasMaximum > 65535) {
					t.emit("error", /* @__PURE__ */ new Error("topicAliasMaximum from broker is out of range"));
					return;
				}
		...
		if (i === 0) t.reconnecting = !1, t._onConnect(e);
		else if (i > 0) {
...
var zy = j((Su) => {
	...
	var H1 = (t, e, r) => {
		...
		let n = typeof r < "u" ? r : t.noop, { messageId: i } = e, s = {
			cmd: "pubcomp",
			messageId: i
		};
...
var Ky = j((Yn) => {
	...
	var V1 = Jn(dy()), G1 = Jn(by()), z1 = Jn(Gy()), K1 = Jn(zn()), Q1 = Jn(zy()), Y1 = (t, e, r) => {
		let { options: n } = t;
		if (n.protocolVersion === 5 && n.properties && n.properties.maximumPacketSize && n.properties.maximumPacketSize < e.length) return t.emit("error", /* @__PURE__ */ new Error(`exceeding packets size ${e.cmd}`)), t.end({
			reasonCode: 149,
...
var Pu = j((Fo, Jy) => {
	...
	(function(t, e) {
		...
		}, a = /* @__PURE__ */ new WeakMap(), f = o(r(a), a);
		t.addUniqueNumber = e(f), t.generateUniqueNumber = f;
	}));
});
var Xn = j((t8, Wt) => {
	A();
	...
	function Ou(t) {
		...
		}, Wt.exports.__esModule = !0, Wt.exports.default = Wt.exports, Ou(t);
	}
	Wt.exports = Ou, Wt.exports.__esModule = !0, Wt.exports.default = Wt.exports;
});
var Zy = j((f8, Zn) => {
	A();
	x();
	...
	Zn.exports = eA, Zn.exports.__esModule = !0, Zn.exports.default = Zn.exports;
});
var eg = j((v8, ei) => {
	A();
	x();
	...
	ei.exports = nA, ei.exports.__esModule = !0, ei.exports.default = ei.exports;
});
var tg = j((k8, ti) => {
	A();
	x();
	...
	ti.exports = oA, ti.exports.__esModule = !0, ti.exports.default = ti.exports;
});
var rg = j((F8, ri) => {
	A();
	x();
	...
	ri.exports = sA, ri.exports.__esModule = !0, ri.exports.default = ri.exports;
});
var ng = j((J8, ni) => {
	A();
	x();
	...
	function aA(t, e) {
		...
		if (r != null) {
			var n, i, s, o, a = [], c = !0, f = !1;
			try {
				if (s = (r = r.call(t)).next, e === 0) {
					if (Object(r) !== r) return;
					c = !1;
				} else for (; !(c = (n = s.call(r)).done) && (a.push(n.value), a.length !== e); c = !0);
			} catch (h) {
				f = !0, i = h;
			} finally {
				try {
	...
	ni.exports = aA, ni.exports.__esModule = !0, ni.exports.default = ni.exports;
});
var ig = j((a6, ii) => {
	A();
	x();
	...
	ii.exports = uA, ii.exports.__esModule = !0, ii.exports.default = ii.exports;
});
var sg = j((b6, oi) => {
	A();
	x();
	...
	oi.exports = lA, oi.exports.__esModule = !0, oi.exports.default = oi.exports;
});
var ag = j((T6, si) => {
	A();
	x();
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
	...
	si.exports = cA, si.exports.__esModule = !0, si.exports.default = si.exports;
});
var ug = j((L6, ai) => {
	A();
	x();
	...
	ai.exports = yA, ai.exports.__esModule = !0, ai.exports.default = ai.exports;
});
var cg = j((z6, ui) => {
	A();
	x();
	...
	ui.exports = gA, ui.exports.__esModule = !0, ui.exports.default = ui.exports;
});
var Ru = j((nW, li) => {
	A();
	x();
	...
	li.exports = bA, li.exports.__esModule = !0, li.exports.default = li.exports;
});
var ku = j((dW, $t) => {
	A();
	x();
	...
	function Wo(t, e, r, n) {
		...
		$t.exports = Wo = function(o, a, c, f) {
			...
			a ? i ? i(o, a, {
				...
				configurable: !f,
				writable: !f
			}) : o[a] = c : (h("next", 0), h("throw", 1), h("return", 2));
		}, $t.exports.__esModule = !0, $t.exports.default = $t.exports, Wo(t, e, r, n);
	}
	$t.exports = Wo, $t.exports.__esModule = !0, $t.exports.default = $t.exports;
});
var Cu = j((EW, Ht) => {
	A();
	x();
	...
	function fg() {
		...
		}, Ht.exports.__esModule = !0, Ht.exports.default = Ht.exports)();
	}
	Ht.exports = fg, Ht.exports.__esModule = !0, Ht.exports.default = Ht.exports;
});
var Nu = j((BW, ci) => {
	A();
	x();
	...
	ci.exports = Mu, ci.exports.__esModule = !0, ci.exports.default = ci.exports;
});
var qu = j(($W, fi) => {
	A();
	x();
	...
	fi.exports = vA, fi.exports.__esModule = !0, fi.exports.default = fi.exports;
});
var hg = j((ZW, hi) => {
	A();
	x();
	...
	hi.exports = EA, hi.exports.__esModule = !0, hi.exports.default = hi.exports;
});
var dg = j((l4, di) => {
	A();
	x();
	...
	function AA(t) {
		...
		return function i() {
			for (; r.length;) if ((n = r.pop()) in e) return i.value = n, i.done = !1, i;
			return i.done = !0, i;
		};
	}
	di.exports = AA, di.exports.__esModule = !0, di.exports.default = di.exports;
});
var pg = j((m4, pi) => {
	A();
	x();
	...
	pi.exports = xA, pi.exports.__esModule = !0, pi.exports.default = pi.exports;
});
var gg = j((O4, Vt) => {
	A();
	x();
	...
	function Lu() {
		...
		return (Vt.exports = Lu = function() {
			return {
				...
				AsyncIterator: kA,
				async: function(c, f, h, d, m) {
					return (n(f) ? RA : OA)(s(c), f, h, d, m);
				},
				keys: CA,
				values: yg
			};
		}, Vt.exports.__esModule = !0, Vt.exports.default = Vt.exports)();
	}
	Vt.exports = Lu, Vt.exports.__esModule = !0, Vt.exports.default = Vt.exports;
});
var wg = j((D4, bg) => {
	A();
	x();
...
var _g = j((Ho, mg) => {
	...
	I();
	(function(t, e) {
		typeof Ho == "object" && typeof mg < "u" ? e(Ho, Pu(), tg(), ug(), cg(), wg()) : typeof define == "function" && define.amd ? define([
			"exports",
			"fast-unique-numbers",
		...
		], e) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.brokerFactory = {}, t.fastUniqueNumbers, t._defineProperty, t._slicedToArray, t._asyncToGenerator, t._regeneratorRuntime));
		...
		function a(S) {
			for (var b = 1; b < arguments.length; b++) {
				...
				b % 2 ? o(Object(w), !0).forEach(function(_) {
					r(S, _, w[_]);
		...
		function d(S) {
			for (var b = 1; b < arguments.length; b++) {
				var w = arguments[b] != null ? arguments[b] : {};
				b % 2 ? h(Object(w), !0).forEach(function(_) {
					r(S, _, w[_]);
						...
						return i(s.mark(function y() {
							...
							return s.wrap(function(U) {
								for (;;) switch (U.prev = U.next) {
									case 0: return O = new MessageChannel(), v = O.port1, M = O.port2, U.next = 1, T("connect", { port: v }, [v]);
									case 1: return F = U.sent, b.set(M, F), U.abrupt("return", M);
									case 2:
							...
							var y = i(s.mark(function O(v) {
								...
								return s.wrap(function(F) {
									for (;;) switch (F.prev = F.next) {
										...
										case 1: return F.next = 2, T("disconnect", { portId: M });
										case 2:
										case "end": return F.stop();
									}
								}, O);
							}));
							return function(O) {
		...
		t.createBroker = c(f(/* @__PURE__ */ new WeakMap()), m(/* @__PURE__ */ new WeakMap()), e.generateUniqueNumber, g);
	}));
});
var Sg = j((Vo, vg) => {
	A();
	...
	I();
	(function(t, e) {
		typeof Vo == "object" && typeof vg < "u" ? e(Vo, _g(), Pu(), Xn()) : typeof define == "function" && define.amd ? define([
			"exports",
			"broker-factory",
			"fast-unique-numbers",
			"@babel/runtime/helpers/typeof"
		], e) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.workerTimersBroker = {}, t.brokerFactory, t.fastUniqueNumbers, t._typeof));
	})(Vo, (function(t, e, r, n) {
		"use strict";
		var i = function(w) {
			return function(_) {
		...
		}, c = new Map([[0, null]]), f = new Map([[0, null]]), h = i(c), d = s(f), m = o(r.generateUniqueNumber, c), g = a(r.generateUniqueNumber, f), P = e.createBroker({
			clearInterval: function(w) {
				var _ = w.call;
				return h(function(R) {
					return _("clear", {
						timerId: R,
...
var Rg = j((Gt) => {
	...
	var NA = Gt && Gt.__createBinding || (Object.create ? (function(t, e, r, n) {
		...
		t.default = e;
	}), LA = Gt && Gt.__importStar || (function() {
		var t = function(e) {
	...
	var Tg = Ag(), Uu = LA(yi()), Pg = {
		set: Tg.setInterval,
		clear: Tg.clearInterval
	}, Og = {
		set: (t, e) => setInterval(t, e),
		clear: (t) => clearInterval(t)
	}, UA = (t) => {
		switch (t) {
			case "native": return Og;
			case "worker": return Pg;
			default: return Uu.default && !Uu.isWebWorker && !Uu.isReactNativeBrowser ? Pg : Og;
		}
	};
	Gt.default = UA;
});
...
var zo = j((yt) => {
	...
	var FA = yt && yt.__createBinding || (Object.create ? (function(t, e, r, n) {
		...
		t.default = e;
	}), Ng = yt && yt.__importStar || (function() {
		var t = function(e) {
			return t = Object.getOwnPropertyNames || function(r) {
				var n = [];
				for (var i in r) Object.prototype.hasOwnProperty.call(r, i) && (n[n.length] = i);
	...
	yt.default = class t extends KA.TypedEventEmitter {
		...
		constructor(e, r) {
			...
			this.log = this.options.log || (0, HA.default)("mqttjs:client"), this.noop = this._noop.bind(this), this.log("MqttClient :: version:", t.VERSION), Bg.isWebWorker ? this.log("MqttClient :: environment", "webworker") : this.log("MqttClient :: environment", Bg.default ? "browser" : "node"), this.log("MqttClient :: options.protocol", r.protocol), this.log("MqttClient :: options.protocolVersion", r.protocolVersion), this.log("MqttClient :: options.username", r.username), this.log("MqttClient :: options.keepalive", r.keepalive), this.log("MqttClient :: options.reconnectPeriod", r.reconnectPeriod), this.log("MqttClient :: options.rejectUnauthorized", r.rejectUnauthorized), this.log("MqttClient :: options.properties.topicAliasMaximum", r.properties ? r.properties.topicAliasMaximum : void 0), this.options.clientId = typeof r.clientId == "string" ? r.clientId : t.defaultId(), this.log("MqttClient :: clientId", this.options.clientId), this.options.customHandleAcks = r.protocolVersion === 5 && r.customHandleAcks ? r.customHandleAcks : (...n) => {
				...
				let { queue: n } = this, i = () => {
					...
					let a = !0;
					o.messageId && o.messageId !== 0 && (this.messageIdProvider.register(o.messageId) || (a = !1)), a ? this._sendPacket(o, (c) => {
						s.cb && s.cb(c), i();
		...
		connect() {
			...
			if (this.options.will && (c.will = {
				...this.options.will,
				payload: this.options.will?.payload
			}), this.topicAliasRecv && (c.properties || (c.properties = {}), this.topicAliasRecv && (c.properties.topicAliasMaximum = this.topicAliasRecv.max)), this._writePacket(c), r.on("error", this.emit.bind(this, "error")), this.options.properties) {
				if (!this.options.properties.authenticationMethod && this.options.properties.authenticationData) return this.end(() => this.emit("error", /* @__PURE__ */ new Error("Packet has no Authentication Method"))), this;
			...
			return this.stream.setMaxListeners(1e3), clearTimeout(this.connackTimer), this.connackTimer = setTimeout(() => {
				this.log("!!connectTimeout hit!! Calling _cleanUp with force `true`"), this.emit("error", /* @__PURE__ */ new Error("connack timeout")), this._cleanUp(!0);
			}, this.options.connectTimeout), this;
		}
		publish(e, r, n, i) {
			this.log("publish :: message `%s` to topic `%s`", r, e);
			let { options: s } = this;
			typeof n == "function" && (i = n, n = null), n = n || {}, n = {
				qos: 0,
				retain: !1,
				dup: !1,
				...n
			...
			let m = () => {
				let g = 0;
				if ((a === 1 || a === 2) && (g = this._nextId(), g === null)) return this.log("No messageId left"), !1;
				let P = {
					cmd: "publish",
					topic: e,
					payload: r,
				...
				switch (s.protocolVersion === 5 && (P.properties = h), this.log("publish :: qos", a), a) {
					case 1:
					case 2:
						this.outgoing[P.messageId] = {
							volatile: !1,
							cb: i || this.noop
						}, this.log("MqttClient:publish: packet cmd: %s", P.cmd), this._sendPacket(P, void 0, d);
						break;
					default:
			...
			return (this._storeProcessing || this._storeProcessingQueue.length > 0 || !m()) && this._storeProcessingQueue.push({
				invoke: m,
		...
		subscribe(e, r, n) {
			...
			if (a !== null) return Wu(n, /* @__PURE__ */ new Error(`Invalid topic ${a}`)), this;
			if (this._checkDisconnecting(n)) return this.log("subscribe: discconecting true"), this;
			let c = { qos: 0 };
			i === 5 && (c.nl = !1, c.rap = !1, c.rh = 0), r = {
				...c,
				...r
			};
			...
			let m = (P, S) => {
				...
				if (f && (b.properties = f), this.options.resubscribe) {
					...
					P.forEach((R) => {
						if (this.options.reconnectPeriod > 0) {
							let T = { qos: R.qos };
							i === 5 && (T.nl = R.nl || !1, T.rap = R.rap || !1, T.rh = R.rh || 0, T.properties = R.properties), this._resubscribeTopics[R.topic] = T, _.push(R.topic);
						}
				...
				for (let b = 0; b < h.length; b += P) {
					...
					if (_ === null) return this.log("No messageId left"), !1;
					S.push(m(w, _));
				}
		...
		unsubscribe(e, r, n) {
			...
			if (i !== null) return Wu(n, /* @__PURE__ */ new Error(`Invalid topic ${i}`)), this;
			if (this._checkDisconnecting(n)) return this;
			let s = () => {
				let o = this._nextId();
				if (o === null) return this.log("No messageId left"), !1;
				let a = {
					cmd: "unsubscribe",
					messageId: o,
					unsubscriptions: []
				...
				}), typeof r == "object" && r.properties && (a.properties = r.properties), this.outgoing[a.messageId] = {
					volatile: !0,
					cb: n
		...
		unsubscribeAsync(e, r) {
			...
			this.log("end :: (%s)", this.options.clientId), (e == null || typeof e != "boolean") && (n = n || r, r = e, e = !1), typeof r != "object" && (n = n || r, r = null), this.log("end :: cb? %s", !!n), (!n || typeof n != "function") && (n = this.noop);
			let i = () => {
				this.log("end :: closeStores: closing incoming and outgoing stores"), this.disconnected = !0, this.incomingStore.close((o) => {
		...
		removeOutgoingMessage(e) {
			if (this.outgoing[e]) {
				...
				this._removeOutgoingAndStoreMessage(e, () => {
					r(/* @__PURE__ */ new Error("Message removed"));
				});
			}
			return this;
		}
		...
		_flushVolatile() {
			this.outgoing && (this.log("_flushVolatile :: deleting volatile messages from the queue and setting their callbacks as error function"), Object.keys(this.outgoing).forEach((e) => {
				this.outgoing[e].volatile && typeof this.outgoing[e].cb == "function" && (this.outgoing[e].cb(/* @__PURE__ */ new Error("Connection closed")), delete this.outgoing[e]);
			}));
		}
		_flush() {
			this.outgoing && (this.log("_flush: queue exists? %b", !!this.outgoing), Object.keys(this.outgoing).forEach((e) => {
				typeof this.outgoing[e].cb == "function" && (this.outgoing[e].cb(/* @__PURE__ */ new Error("Connection closed")), delete this.outgoing[e]);
			}));
		}
		_removeTopicAliasAndRecoverTopicName(e) {
			...
			if (this.log("_removeTopicAliasAndRecoverTopicName :: alias %d, topic %o", r, n), n.length === 0) {
				if (typeof r > "u") return /* @__PURE__ */ new Error("Unregistered Topic Alias");
				if (n = this.topicAliasSend.getTopicByAlias(r), typeof n > "u") return /* @__PURE__ */ new Error("Unregistered Topic Alias");
				e.topic = n;
			}
			r && delete e.properties.topicAlias;
		}
		_checkDisconnecting(e) {
			return this.disconnecting && (e && e !== this.noop ? e(/* @__PURE__ */ new Error("client disconnecting")) : this.emit("error", /* @__PURE__ */ new Error("client disconnecting"))), this.disconnecting;
		}
		_reconnect() {
		...
		_applyTopicAlias(e) {
			if (this.options.protocolVersion === 5 && e.cmd === "publish") {
				...
				if (this.topicAliasSend) if (r) {
					if (n.length !== 0 && (this.log("applyTopicAlias :: register topic: %s - alias: %d", n, r), !this.topicAliasSend.put(n, r))) return this.log("applyTopicAlias :: error out of range. topic: %s - alias: %d", n, r), /* @__PURE__ */ new Error("Sending Topic Alias out of range");
				} else n.length !== 0 && (this.options.autoAssignTopicAlias ? (r = this.topicAliasSend.getAliasByTopic(n), r ? (e.topic = "", e.properties = {
					...e.properties,
					topicAlias: r
				}, this.log("applyTopicAlias :: auto assign(use) topic: %s - alias: %d", n, r)) : (r = this.topicAliasSend.getLruAlias(), this.topicAliasSend.put(n, r), e.properties = {
					...e.properties,
					topicAlias: r
				}, this.log("applyTopicAlias :: auto assign topic: %s - alias: %d", n, r))) : this.options.autoUseTopicAlias && (r = this.topicAliasSend.getAliasByTopic(n), r && (e.topic = "", e.properties = {
					...e.properties,
					topicAlias: r
				}, this.log("applyTopicAlias :: auto use topic: %s - alias: %d", n, r))));
				else if (r) return this.log("applyTopicAlias :: error out of range. topic: %s - alias: %d", n, r), /* @__PURE__ */ new Error("Sending Topic Alias out of range");
			}
		}
		_noop(e) {
			this.log("noop ::", e);
		...
		_storePacket(e, r, n) {
			...
			let s = i.qos || 0;
			s === 0 && this.queueQoSZero || i.cmd !== "publish" ? this.queue.push({
				packet: i,
				cb: r
			}) : s > 0 ? (r = this.outgoing[i.messageId] ? this.outgoing[i.messageId].cb : null, this.outgoingStore.put(i, (o) => {
				if (o) return r && r(o);
				n();
			})) : r && r(/* @__PURE__ */ new Error("No connection to broker"));
		}
		...
		onKeepaliveTimeout() {
			this.emit("error", /* @__PURE__ */ new Error("Keepalive timeout")), this.log("onKeepaliveTimeout :: calling _cleanUp with force true"), this._cleanUp(!0);
		}
		_resubscribe() {
			...
			if (!this._firstConnection && (this.options.clean || this.options.protocolVersion >= 4 && !this.connackPacket.sessionPresent) && e.length > 0) if (this.options.resubscribe) if (this.options.protocolVersion === 5) {
				...
				for (let r = 0; r < e.length; r++) {
					let n = {};
					n[e[r]] = this._resubscribeTopics[e[r]], n.resubscribe = !0, this.subscribe(n, { properties: n[e[r]].properties });
				}
		...
		_onConnect(e) {
			...
			let r = () => {
				...
				let o = () => {
					...
					if (this._storeProcessing = !0, this._packetIdsDuringStoreProcessing[a.messageId]) {
						o();
						return;
					}
					!this.disconnecting && !this.reconnectTimer ? (c = this.outgoing[a.messageId] ? this.outgoing[a.messageId].cb : null, this.outgoing[a.messageId] = {
						volatile: !1,
						cb(f, h) {
							c && c(f, h), o();
						}
					}, this._packetIdsDuringStoreProcessing[a.messageId] = !0, this.messageIdProvider.register(a.messageId) ? this._sendPacket(a, void 0, void 0, !0) : this.log("messageId: %d has already used.", a.messageId)) : n.destroy && n.destroy();
				};
				n.on("end", () => {
					let a = !0;
		...
		_flushStoreProcessingQueue() {
			for (let e of this._storeProcessingQueue) e.cbStorePut && e.cbStorePut(/* @__PURE__ */ new Error("Connection closed")), e.callback && e.callback(/* @__PURE__ */ new Error("Connection closed"));
...
function JA() {
	if (Lg) return Gu;
	Lg = !0;
	let t = 2147483647, e = 36, r = 1, n = 26, i = 38, s = 700, o = 72, a = 128, c = "-", f = /^xn--/, h = /[^\0-\x7F]/, d = /[\x2E\u3002\uFF0E\uFF61]/g, m = {
		overflow: "Overflow: input needs wider integers to process",
		"not-basic": "Illegal input >= 0x80 (not a basic code point)",
		"invalid-input": "Invalid input"
	}, g = e - r, P = Math.floor, S = String.fromCharCode;
	function b(H) {
...
var Gu, Lg, hr, Ug = ze(() => {
	...
	I();
	Gu = {}, Lg = !1;
	hr = JA(), hr.decode, hr.encode, hr.toASCII, hr.toUnicode, hr.ucs2, hr.version;
});
function XA() {
	return Dg || (Dg = !0, zu = function() {
...
function ZA() {
	return jg || (jg = !0, Ku = Error), Ku;
}
function eI() {
	return Fg || (Fg = !0, Qu = EvalError), Qu;
}
function tI() {
	return Wg || (Wg = !0, Yu = RangeError), Yu;
}
function rI() {
	return $g || ($g = !0, Ju = ReferenceError), Ju;
}
function sb() {
	return Hg || (Hg = !0, Xu = SyntaxError), Xu;
}
function Sn() {
	return Vg || (Vg = !0, Zu = TypeError), Zu;
}
function nI() {
	return Gg || (Gg = !0, el = URIError), el;
}
function iI() {
	if (zg) return tl;
	zg = !0;
...
function Wr() {
	...
	var d = function() {
		...
		return G.__proto__;
	} : null), b = {}, w = typeof Uint8Array > "u" || !S ? t : S(Uint8Array), _ = {
		__proto__: null,
		"%AggregateError%": typeof AggregateError > "u" ? t : AggregateError,
		"%Array%": Array,
		"%ArrayBuffer%": typeof ArrayBuffer > "u" ? t : ArrayBuffer,
		"%ArrayIteratorPrototype%": g && S ? S([][Symbol.iterator]()) : t,
		...
		"%isFinite%": isFinite,
		"%isNaN%": isNaN,
		"%IteratorPrototype%": g && S ? S(S([][Symbol.iterator]())) : t,
		"%JSON%": typeof JSON == "object" ? JSON : t,
		"%Map%": typeof Map > "u" ? t : Map,
		"%MapIteratorPrototype%": typeof Map > "u" || !g || !S ? t : S((/* @__PURE__ */ new Map())[Symbol.iterator]()),
		"%Math%": Math,
		"%Number%": Number,
		"%Object%": Object,
		...
		"%SetIteratorPrototype%": typeof Set > "u" || !g || !S ? t : S((/* @__PURE__ */ new Set())[Symbol.iterator]()),
		"%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? t : SharedArrayBuffer,
		"%String%": String,
		"%StringIteratorPrototype%": g && S ? S(""[Symbol.iterator]()) : t,
		"%Symbol%": g ? Symbol : t,
		"%SyntaxError%": s,
		"%ThrowTypeError%": m,
		"%TypedArray%": w,
	...
	}, O = dl(), v = aI(), M = O.call(Function.call, Array.prototype.concat), F = O.call(Function.apply, Array.prototype.splice), U = O.call(Function.call, String.prototype.replace), Q = O.call(Function.call, String.prototype.slice), W = O.call(Function.call, RegExp.prototype.exec), H = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, z = /\\(\\)?/g, J = function(V) {
	...
	return sl = function(V, te) {
		...
		var Y = J(V), X = Y.length > 0 ? Y[0] : "", ce = ee("%" + X + "%", te), Z = ce.name, ne = ce.value, he = !1, be = ce.alias;
		be && (X = be[0], F(Y, M([0, 1], be)));
		for (var ye = 1, Ae = !0; ye < Y.length; ye += 1) {
			...
			if ((_e === "constructor" || !Ae) && (he = !0), X += "." + _e, Z = "%" + X + "%", v(_, Z)) ne = _[Z];
			else if (ne != null) {
				if (!(_e in ne)) {
...
function pl() {
	if (Zg) return al;
	Zg = !0;
	var e = Wr()("%Object.defineProperty%", !0) || !1;
	if (e) try {
		e({}, "a", { value: 1 });
	} catch {
		e = !1;
...
function ab() {
	if (eb) return ul;
	eb = !0;
	var e = Wr()("%Object.getOwnPropertyDescriptor%", !0);
	if (e) try {
		e([], "length");
	} catch {
		e = null;
...
function uI() {
	...
	return ll = function(s, o, a) {
		...
		var c = arguments.length > 3 ? arguments[3] : null, f = arguments.length > 4 ? arguments[4] : null, h = arguments.length > 5 ? arguments[5] : null, d = arguments.length > 6 ? arguments[6] : !1, m = !!n && n(s, o);
		if (t) t(s, o, {
...
function cI() {
	...
	return fl = function(a, c) {
		...
		var f = arguments.length > 2 && !!arguments[2], h = !0, d = !0;
		if ("length" in a && n) {
			var m = n(a, "length");
			m && !m.configurable && (h = !1), m && !m.writable && (d = !1);
		}
		return (h || d || !f) && (r ? e(a, "length", c, !0, !0) : e(a, "length", c)), a;
	}, fl;
}
function fI() {
	if (ib) return wi;
	ib = !0;
	var t = dl(), e = Wr(), r = cI(), n = Sn(), i = e("%Function.prototype.apply%"), s = e("%Function.prototype.call%"), o = e("%Reflect.apply%", !0) || t.call(s, i), a = pl(), c = e("%Math.max%");
	wi = function(d) {
		if (typeof d != "function") throw new n("a function is required");
		return r(o(t, s, arguments), 1 + c(0, d.length - (arguments.length - 1)), !0);
	};
	var f = function() {
...
var zu, Dg, Ku, jg, Qu, Fg, Yu, Wg, Ju, $g, Xu, Hg, Zu, Vg, el, Gg, tl, zg, rl, Kg, nl, Qg, il, Yg, ol, Jg, sl, Xg, al, Zg, ul, eb, ll, tb, cl, rb, fl, nb, wi, ib, hl, ob, lb = ze(() => {
	A();
	x();
	I();
	zu = {}, Dg = !1;
...
function hI() {
	!En || !$r || (En = !1, $r.length ? zt = $r.concat(zt) : Ko = -1, zt.length && cb());
}
function cb() {
	if (!En) {
...
function bl(t) {
	var e = Math.floor((Date.now() - dr.now()) * .001), r = dr.now() * .001, n = Math.floor(r) + e, i = Math.floor(r % 1 * 1e9);
...
var zt, En, $r, Ko, pI, yI, gI, bI, wI, mI, _I, vI, SI, EI, AI, II, xI, TI, PI, OI, kI, CI, BI, LI, UI, ml, DI, jI, FI, WI, $I, HI, GI, zI, KI, YI, JI, XI, ZI, ex, tx, rx, nx, ix, ox, sx, ax, ux, lx, cx, fx, dr, yl, gl, dx, px, yx, gx, bx, mx, _x, vx, Sx, Ex, Ax, _l, vl = ze(() => {
	A();
	x();
	I();
	zt = [], En = !1, Ko = -1;
	...
	pI = "browser", yI = "x64", gI = "browser", bI = {
		PATH: "/usr/bin",
		LANG: navigator.language + ".UTF-8",
		PWD: "/",
		HOME: "/home",
		TMP: "/tmp"
	}, wI = ["/usr/bin/node"], mI = [], _I = "v16.8.0", vI = {}, SI = function(t, e) {
		console.warn((e ? e + ": " : "") + t);
	}, EI = function(t) {
		wl("binding");
	}, AI = function(t) {
	...
	YI = We, JI = We, XI = We, ZI = We, ex = We, tx = void 0, rx = void 0, nx = void 0, ix = We, ox = 2, sx = 1, ax = "/bin/usr/node", ux = 9229, lx = "node", cx = [], fx = We, dr = {
		now: typeof performance < "u" ? performance.now.bind(performance) : void 0,
		timing: typeof performance < "u" ? performance.timing : void 0
	};
	...
	_l = {
		...
		off: mx,
		removeListener: _x,
		removeAllListeners: vx,
		emit: Sx,
		prependListener: Ex,
		prependOnceListener: Ax,
		listeners: Ix,
		domain: kI,
		_exiting: CI,
		config: BI,
		dlopen: MI,
		uptime: hx,
		_getActiveRequests: NI,
		_getActiveHandles: qI,
		reallyExit: LI,
		_kill: UI,
		cpuUsage: ml,
		resourceUsage: DI,
		...
		exit: WI,
		openStdin: $I,
		allowedNodeEnvironmentFlags: HI,
		assert: VI,
		features: GI,
		_fatalExceptions: zI,
		setUncaughtExceptionCaptureCallback: KI,
		hasUncaughtExceptionCaptureCallback: QI,
		emitWarning: SI,
		nextTick: dI,
		_tickCallback: YI,
		_debugProcess: JI,
		_debugEnd: XI,
		_startProfilerIdleNotifier: ZI,
		_stopProfilerIdleNotifier: ex,
		stdout: tx,
		stdin: nx,
		stderr: rx,
		abort: ix,
...
function xx() {
	...
	var i = {
		resolve: function() {
			for (var o = "", a = !1, c, f = arguments.length - 1; f >= -1 && !a; f--) {
				var h;
		...
		relative: function(o, a) {
			...
			for (var g = a.length - d, P = h < g ? h : g, S = -1, b = 0; b <= P; ++b) {
				if (b === P) {
					if (g > P) {
				...
				var w = o.charCodeAt(c + b);
				if (w !== a.charCodeAt(d + b)) break;
				w === 47 && (S = b);
			}
			var R = "";
		...
		dirname: function(o) {
			if (e(o), o.length === 0) return ".";
			for (var a = o.charCodeAt(0), c = a === 47, f = -1, h = !0, d = o.length - 1; d >= 1; --d) if (a = o.charCodeAt(d), a === 47) {
				if (!h) {
					f = d;
					break;
				}
		...
		basename: function(o, a) {
			...
			if (a !== void 0 && a.length > 0 && a.length <= o.length) {
				...
				for (d = o.length - 1; d >= 0; --d) {
					...
					} else g === -1 && (h = !1, g = d + 1), m >= 0 && (P === a.charCodeAt(m) ? --m === -1 && (f = d) : (m = -1, f = g));
				}
		...
		extname: function(o) {
			e(o);
			for (var a = -1, c = 0, f = -1, h = !0, d = 0, m = o.length - 1; m >= 0; --m) {
				...
				f === -1 && (h = !1, f = m + 1), g === 46 ? a === -1 ? a = m : d !== 1 && (d = 1) : a !== -1 && (d = -1);
			}
		...
		parse: function(o) {
			...
			f ? (a.root = "/", h = 1) : h = 0;
			for (var d = -1, m = 0, g = -1, P = !0, S = o.length - 1, b = 0; S >= h; --S) {
				...
				g === -1 && (P = !1, g = S + 1), c === 46 ? d === -1 ? d = S : b !== 1 && (b = 1) : d !== -1 && (b = -1);
			}
...
function Px() {
	...
	Al = function k(B, re, ie, oe) {
		...
		if (Re(fe, "maxStringLength") && (typeof fe.maxStringLength == "number" ? fe.maxStringLength < 0 && fe.maxStringLength !== Infinity : fe.maxStringLength !== null)) throw new TypeError("option \"maxStringLength\", if provided, must be a positive integer, Infinity, or `null`");
		var Qt = Re(fe, "customInspect") ? fe.customInspect : !0;
		...
		if (typeof B == "number") {
			if (B === 0) return Infinity / B > 0 ? "0" : "-0";
			var Ye = String(B);
			return br ? V(B, Ye) : Ye;
		}
		if (typeof B == "bigint") {
		...
		if (!he(B) && !be(B)) {
			var is = $(B, ut), nc = G ? G(B) === Object.prototype : B instanceof Object || B.constructor === Object, os = B instanceof Object ? "" : "null prototype", ic = !nc && J && Object(B) === B && J in B ? _.call(Ne(B), 8, -1) : os ? "Object" : "", ss = (nc || typeof B.constructor != "function" ? "" : B.constructor.name ? B.constructor.name + " " : "") + (ic || os ? "[" + M.call(v.call([], ic || [], os || []), ": ") + "] " : "");
	...
	function Oe(k) {
		...
		if (!k || typeof k != "object" || !H) return !1;
		try {
			return H.call(k), !0;
		} catch {}
		return !1;
	...
	function xe(k) {
		if (!k || typeof k != "object" || !Q) return !1;
		try {
			return Q.call(k), !0;
		} catch {}
		return !1;
	...
	function xn(k) {
		if (!r || !k || typeof k != "object") return !1;
		try {
			r.call(k);
			try {
				o.call(k);
	...
	function Vr(k) {
		if (!g || !k || typeof k != "object") return !1;
		try {
			return g.call(k), !0;
		} catch {}
		return !1;
	...
	function Ze(k) {
		if (!o || !k || typeof k != "object") return !1;
		try {
			o.call(k);
			try {
				r.call(k);
	...
	function Tn(k) {
		if (!d || !k || typeof k != "object") return !1;
		try {
			d.call(k, d);
			try {
				f.call(k, f);
	...
	function at(k, B) {
		...
		return ce(R.call(R.call(k, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, Zo), "single", B);
	}
	function Zo(k) {
		var B = k.charCodeAt(0), re = {
			8: "b",
			9: "t",
			10: "n",
			12: "f",
...
function Ox() {
	if (yb) return xl;
	yb = !0;
	var t = Wr(), e = ub(), r = Px(), n = Sn(), i = t("%WeakMap%", !0), s = t("%Map%", !0), o = e("WeakMap.prototype.get", !0), a = e("WeakMap.prototype.set", !0), c = e("WeakMap.prototype.has", !0), f = e("Map.prototype.get", !0), h = e("Map.prototype.set", !0), d = e("Map.prototype.has", !0), m = function(b, w) {
	...
	return xl = function() {
		var w, _, R, T = {
			...
			set: function(y, O) {
				i && y && (typeof y == "object" || typeof y == "function") ? (w || (w = new i()), a(w, y, O)) : s ? (_ || (_ = new s()), h(_, y, O)) : (R || (R = {
					key: {},
					next: null
				}), P(R, y, O));
			}
...
function Sb() {
	...
	var t = Bl(), e = Object.prototype.hasOwnProperty, r = Array.isArray, n = (function() {
		...
		for (var R = _ && _.plainObjects ? Object.create(null) : {}, T = 0; T < w.length; ++T) typeof w[T] < "u" && (R[T] = w[T]);
		return R;
	}, o = function b(w, _, R) {
		if (!_) return w;
		if (typeof _ != "object") {
			if (r(w)) w.push(_);
			else if (w && typeof w == "object") (R && (R.plainObjects || R.allowPrototypes) || !e.call(Object.prototype, _)) && (w[_] = !0);
			else return [w, _];
			return w;
		}
		...
		for (var _ = [{
			obj: { o: w },
			prop: "o"
		}], R = [], T = 0; T < _.length; ++T) for (var y = _[T], O = y.obj[y.prop], v = Object.keys(O), M = 0; M < v.length; ++M) {
			var F = v[M], U = O[F];
			typeof U == "object" && U !== null && R.indexOf(U) === -1 && (_.push({
				obj: O,
				prop: F
			}), R.push(U));
		}
...
function Rx() {
	if (wb) return Ol;
	wb = !0;
	var t = Ox(), e = Sb(), r = Bl(), n = Object.prototype.hasOwnProperty, i = {
		brackets: function(b) {
			return b + "[]";
		},
		comma: "comma",
		...
		o.apply(S, s(b) ? b : [b]);
	}, c = Date.prototype.toISOString, f = r.default, h = {
		addQueryPrefix: !1,
		allowDots: !1,
		allowEmptyArrays: !1,
		arrayFormat: "indices",
		...
		for (var V = b, te = G, Y = 0, X = !1; (te = te.get(m)) !== void 0 && !X;) {
			var ce = te.get(b);
			if (Y += 1, typeof ce < "u") {
		...
		if (d(V) || e.isBuffer(V)) {
			if (M) return [z(J ? w : M(w, h.encoder, ee, "key", H)) + "=" + z(M(V, h.encoder, ee, "value", H))];
		...
		var O = typeof b.allowDots > "u" ? b.encodeDotInKeys === !0 ? !0 : h.allowDots : !!b.allowDots;
		return {
			addQueryPrefix: typeof b.addQueryPrefix == "boolean" ? b.addQueryPrefix : h.addQueryPrefix,
			allowDots: O,
			allowEmptyArrays: typeof b.allowEmptyArrays == "boolean" ? !!b.allowEmptyArrays : h.allowEmptyArrays,
			arrayFormat: y,
			charset: w,
			charsetSentinel: typeof b.charsetSentinel == "boolean" ? b.charsetSentinel : h.charsetSentinel,
			commaRoundTrip: b.commaRoundTrip,
			delimiter: typeof b.delimiter > "u" ? h.delimiter : b.delimiter,
			encode: typeof b.encode == "boolean" ? b.encode : h.encode,
			encodeDotInKeys: typeof b.encodeDotInKeys == "boolean" ? b.encodeDotInKeys : h.encodeDotInKeys,
			encoder: typeof b.encoder == "function" ? b.encoder : h.encoder,
			encodeValuesOnly: typeof b.encodeValuesOnly == "boolean" ? b.encodeValuesOnly : h.encodeValuesOnly,
			filter: T,
			format: _,
			formatter: R,
			serializeDate: typeof b.serializeDate == "function" ? b.serializeDate : h.serializeDate,
			skipNulls: typeof b.skipNulls == "boolean" ? b.skipNulls : h.skipNulls,
			sort: typeof b.sort == "function" ? b.sort : null,
			strictNullHandling: typeof b.strictNullHandling == "boolean" ? b.strictNullHandling : h.strictNullHandling
		};
	};
	return Ol = function(S, b) {
		...
		var Q = y.join(_.delimiter), W = _.addQueryPrefix === !0 ? "?" : "";
...
function kx() {
	if (mb) return Rl;
	mb = !0;
	var t = Sb(), e = Object.prototype.hasOwnProperty, r = Array.isArray, n = {
		allowDots: !1,
		allowEmptyArrays: !1,
		allowPrototypes: !1,
		allowSparse: !1,
		...
		var w = P.parameterLimit === Infinity ? void 0 : P.parameterLimit, _ = b.split(P.delimiter, w), R = -1, T, y = P.charset;
		...
		for (var b = S ? g : s(g, P), w = m.length - 1; w >= 0; --w) {
			...
			if (R === "[]" && P.parseArrays) _ = P.allowEmptyArrays && (b === "" || P.strictNullHandling && b === null) ? [] : [].concat(b);
				...
				_ = P.plainObjects ? Object.create(null) : {};
		...
		if (g) {
			...
			if (T) {
				if (S.strictDepth === !0) throw new RangeError("Input depth exceeded depth option of " + S.depth + " and strictDepth is true");
		...
		return {
			allowDots: typeof g.allowDots > "u" ? g.decodeDotInKeys === !0 ? !0 : n.allowDots : !!g.allowDots,
			...
			delimiter: typeof g.delimiter == "string" || t.isRegExp(g.delimiter) ? g.delimiter : n.delimiter,
	...
	return Rl = function(m, g) {
		var P = d(g);
		if (m === "" || m === null || typeof m > "u") return P.plainObjects ? Object.create(null) : {};
		for (var S = typeof m == "string" ? c(m, P) : m, b = P.plainObjects ? Object.create(null) : {}, w = Object.keys(S), _ = 0; _ < w.length; ++_) {
			var R = w[_], T = h(R, S[R], P, typeof m == "string");
			b = t.merge(b, T, P);
		}
		return P.allowSparse === !0 ? b : t.compact(b);
	}, Rl;
}
function Cx() {
	if (_b) return kl;
...
`,
		...
		"?",
		"#"
	], h = 255, d = /^[+a-z0-9A-Z_-]{0,63}$/, m = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, g = {
		javascript: !0,
		"javascript:": !0
	}, P = {
		javascript: !0,
	...
	e.prototype.parse = function(y, O, v) {
		...
		var M = y.indexOf("?"), F = M !== -1 && M < y.indexOf("#") ? "?" : "#", U = y.split(F);
		U[0] = U[0].replace(/\\/g, "/"), y = U.join(F);
		var W = y;
		...
		if (v || z || W.match(/^\/\/[^@/]+@[^@/]+/)) {
			var ee = W.substr(0, 2) === "//";
			ee && !(z && P[z]) && (W = W.substr(2), this.slashes = !0);
		}
		if (!P[z] && (ee || z && !S[z])) {
	...
	e.prototype.format = function() {
		...
		var O = this.protocol || "", v = this.pathname || "", M = this.hash || "", F = !1, U = "";
		this.host ? F = y + this.host : this.hostname && (F = y + (this.hostname.indexOf(":") === -1 ? this.hostname : "[" + this.hostname + "]"), this.port && (F += ":" + this.port)), this.query && typeof this.query == "object" && Object.keys(this.query).length && (U = b.stringify(this.query, {
			arrayFormat: "repeat",
			addQueryPrefix: !1
		}));
		var Q = this.search || U && "?" + U || "";
		return O && O.substr(-1) !== ":" && (O += ":"), this.slashes || (!O || S[O]) && F !== !1 ? (F = "//" + (F || ""), v && v.charAt(0) !== "/" && (v = "/" + v)) : F || (F = ""), M && M.charAt(0) !== "#" && (M = "#" + M), Q && Q.charAt(0) !== "?" && (Q = "?" + Q), v = v.replace(/[?#]/g, function(W) {
			return encodeURIComponent(W);
		}), Q = Q.replace("#", "%23"), O + F + v + Q + M;
	};
	function R(y, O) {
		return w(y, !1, !0).resolve(O);
	}
	e.prototype.resolve = function(y) {
		return this.resolveObject(w(y, !1, !0)).format();
	};
	function T(y, O) {
		return y ? w(y, !1, !0).resolveObject(O) : O;
	}
	return e.prototype.resolveObject = function(y) {
		...
		if (y.protocol && y.protocol !== v.protocol) {
			...
			if (v.search = y.search, v.query = y.query, v.host = y.host || "", v.auth = y.auth, v.hostname = y.hostname || y.host, v.port = y.port, v.pathname || v.search) v.path = (v.pathname || "") + (v.search || "");
		...
		if (he && (v.hostname = "", v.port = null, v.host && (Z[0] === "" ? Z[0] = v.host : Z.unshift(v.host)), v.host = "", y.protocol && (y.hostname = null, y.port = null, y.host && (ne[0] === "" ? ne[0] = y.host : ne.unshift(y.host)), y.host = null), X = X && (ne[0] === "" || Z[0] === "")), Y) v.host = y.host || y.host === "" ? y.host : v.host, v.hostname = y.hostname || y.hostname === "" ? y.hostname : v.hostname, v.search = y.search, v.query = y.query, Z = ne;
			...
			if (he) {
				...
				var be = v.host && v.host.indexOf("@") > 0 ? v.host.split("@") : !1;
...
var Tx, Al, pb, Il, xl, yb, Tl, gb, Pl, bb, Ol, wb, Rl, mb, kl, _b, Hr, vb, Ge, Mx, Nx, qx, Lx, Ux, Dx, jx, Fx, Wx, $x, Hx, Cl, Vx, Gx, zx, Kx, Qx, Yx, xb = ze(() => {
	A();
	x();
	I();
	Ug();
	...
	db();
	vl();
	Tx = Object.freeze(Object.create(null)), Al = {}, pb = !1, Il = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : global;
	xl = {}, yb = !1;
	Tl = {}, gb = !1;
	Pl = {}, bb = !1;
	Ol = {}, wb = !1;
...
var Qo = j((mi) => {
	...
	var Ml = class extends Zx.Duplex {
		...
		writeQueue;
		constructor(e, r, n) {
			super({ objectMode: !0 }), this.proxy = r, this.socket = n, this.writeQueue = [], e.objectMode || (this._writev = Rb.bind(this)), this.isSocketOpen = !1, this.proxy.on("data", (i) => {
		...
		_write(e, r, n) {
			this.isSocketOpen ? this.writeToProxy(e, r, n) : this.writeQueue.push({
				chunk: e,
				encoding: r,
				cb: n
			});
		...
		writeToProxy(e, r, n) {
			this.proxy.write(e, r) === !1 ? this.proxy.once("drain", n) : n();
		}
		processWriteQueue() {
...
var _i = j((gr) => {
	...
	var Yo = (ke(), me(qe)), kb = ql(Pb()), eT = ql(At()), tT = or(), rT = ql(yi()), Nl = Qo(), yr = (0, eT.default)("mqttjs:ws"), nT = [
		"rejectUnauthorized",
		"ca",
		"cert",
		"key",
	...
	var uT = (t, e) => {
		...
		function g(w) {
			...
			let _ = /* @__PURE__ */ new Error("WebSocket error");
...
Kr(Ll, {
	...
	Socket: () => Je,
	Stream: () => Je,
	_createServerHandle: () => Je,
	_normalizeArgs: () => Je,
	_setSimultaneousAccepts: () => Je,
	connect: () => Je,
	createConnection: () => Je,
	createServer: () => Je,
	default: () => lT,
...
var Fl = j((vi) => {
	...
	var cT = jl((Ul(), me(Ll))), fT = jl(At()), hT = jl(Dl()), dT = (0, fT.default)("mqttjs:tcp"), pT = (t, e) => {
		...
		return dT("port %d and host %s", r, i), cT.default.createConnection({
			port: r,
			host: i,
			path: n
		});
...
var $l = j((Si) => {
	...
	var vT = (t, e) => {
		e.port = e.port || 8883, e.host = e.hostname || e.host || "localhost", gT.default.isIP(e.host) === 0 && (e.servername = e.host), e.rejectUnauthorized = e.rejectUnauthorized !== !1, delete e.path, mT("port %d host %s rejectUnauthorized %b", e.port, e.host, e.rejectUnauthorized);
		let r = _T(e);
		r.on("secureConnect", () => {
			e.rejectUnauthorized && !r.authorized ? r.emit("error", /* @__PURE__ */ new Error("TLS not authorized")) : r.removeListener("error", n);
		});
		function n(i) {
...
var Gl = j((Vl) => {
	...
	var PT = (t, e) => {
		...
		kt = wx.connectSocket({
			url: n,
			protocols: [r]
		}), Hl = AT(), Xe = new ET.BufferedDuplex(e, Hl, kt), Xe._destroy = (s, o) => {
			kt.close({ success() {
				o && o(s);
			} });
		};
...
var Ql = j((Kl) => {
	...
	var zl = (ke(), me(qe)), OT = or(), RT = Qo(), Kt, Ei, An, Db = !1;
	function kT() {
		let t = new OT.Transform();
		return t._write = (e, r, n) => {
			Kt.sendSocketMessage({
				data: e.buffer,
				success() {
					n();
				},
				fail() {
					n(/* @__PURE__ */ new Error());
				}
			});
		}, t._flush = (e) => {
	...
	var NT = (t, e) => {
		...
		CT(e);
		let n = BT(e, t);
		return Kt = e.my, Kt.connectSocket({
			url: n,
			protocols: r
		}), Ei = kT(), An = new RT.BufferedDuplex(e, Ei, Kt), MT(), An;
	};
	Kl.default = NT;
});
var $b = j((In) => {
	...
	function Wb(t, e) {
		if (Fb("connecting to an MQTT broker..."), typeof t == "object" && !e && (e = t, t = ""), e = e || {}, t && typeof t == "string") {
			let i = LT.default.parse(t, !0), s = {};
			if (i.port != null && (s.port = Number(i.port)), s.host = i.hostname, s.query = i.query, s.auth = i.auth, s.protocol = i.protocol, s.path = i.path, e = {
				...s,
				...e
			}, !e.protocol) throw new Error("Missing protocol");
		...
		if (e.unixSocket = e.unixSocket || e.protocol?.includes("+unix"), e.unixSocket ? e.protocol = e.protocol.replace("+unix", "") : !e.protocol?.startsWith("ws") && !e.protocol?.startsWith("wx") && delete e.path, DT(e), e.query && typeof e.query.clientId == "string" && (e.clientId = e.query.clientId), jb.default || e.unixSocket ? e.socksProxy = void 0 : e.socksProxy === void 0 && typeof N < "u" && (e.socksProxy = N.env.MQTTJS_SOCKS_PROXY), e.cert && e.key) if (e.protocol) {
			if ([
				...
				"wxs",
				"alis"
			].indexOf(e.protocol) === -1) switch (e.protocol) {
				case "mqtt":
					e.protocol = "mqtts";
					break;
				case "ws":
				...
				case "ali":
					e.protocol = "alis";
					break;
				default: throw new Error(`Unknown protocol for secure connection: "${e.protocol}"!`);
			}
		...
		if (Me || (Me = {}, !jb.default && !e.forceNativeWebSocket ? (Me.ws = _i().streamBuilder, Me.wss = _i().streamBuilder, Me.mqtt = Fl().default, Me.tcp = Fl().default, Me.ssl = $l().default, Me.tls = Me.ssl, Me.mqtts = $l().default) : (Me.ws = _i().browserStreamBuilder, Me.wss = _i().browserStreamBuilder, Me.wx = Gl().default, Me.wxs = Gl().default, Me.ali = Ql().default, Me.alis = Ql().default)), !Me[e.protocol]) {
			...
			e.protocol = [
				...
				"ali",
				"alis"
			].filter((s, o) => i && o % 2 === 0 ? !1 : typeof Me[s] == "function")[0];
		}
	...
	function jT(t, e, r = !0) {
		return new Promise((n, i) => {
			...
			r === !1 && (o.close = () => {
				o.error(/* @__PURE__ */ new Error("Couldn't connect to server"));
			});
			function a() {
...
var Jl = j((ge) => {
	...
	var Hb = ge && ge.__createBinding || (Object.create ? (function(t, e, r, n) {
		...
		t.default = e;
	}), WT = ge && ge.__importStar || (function() {
		var t = function(e) {
			return t = Object.getOwnPropertyNames || function(r) {
				var n = [];
				for (var i in r) Object.prototype.hasOwnProperty.call(r, i) && (n[n.length] = i);
	...
	ge.DefaultMessageIdProvider = Ai(Iu()).default;
	ge.UniqueMessageIdProvider = Ai(qg()).default;
	ge.Store = Ai(Ua()).default;
	var Gb = WT($b());
	ge.connect = Gb.default;
	Object.defineProperty(ge, "connectAsync", {
		enumerable: !0,
		get: function() {
			return Gb.connectAsync;
		}
	});
	ge.KeepaliveManager = Ai(ju()).default;
	ge.Client = Vb.default;
	Yl(zo(), ge);
	Yl(Mr(), ge);
	Yl(Na(), ge);
	var zT = zn();
	Object.defineProperty(ge, "ReasonCodes", {
		enumerable: !0,
		get: function() {
...
var mqtt_esm_default = j((ot) => {
	...
	var zb = ot && ot.__createBinding || (Object.create ? (function(t, e, r, n) {
		...
		t.default = e;
	}), QT = ot && ot.__importStar || (function() {
		var t = function(e) {
			return t = Object.getOwnPropertyNames || function(r) {
				var n = [];
				for (var i in r) Object.prototype.hasOwnProperty.call(r, i) && (n[n.length] = i);
...
*/
//#endregion
export { mqtt_esm_default as default };
